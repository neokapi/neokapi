...
func NewPlatformProvider(cfg PlatformProviderConfig, deployment string) (provider.LLMProvider, error) {
	...
	return provider.NewAzureOpenAITokenProvider(cfg.Endpoint, deployment, tp), nil
}
