...
var sqliteJobMigrations = []storage.Migration{
	...
	{
		Version:     5,
		Description: "add step_id column for automation run visibility (AD-035)",
		SQL: `
			ALTER TABLE translation_jobs ADD COLUMN step_id TEXT NOT NULL DEFAULT '';
			ALTER TABLE extraction_jobs ADD COLUMN step_id TEXT NOT NULL DEFAULT '';
		`,
	},
}
