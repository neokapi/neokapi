...
func TestPhase3_DenyRuleOverridesGrant(t *testing.T) {
	...
	require.NotEqual(t, http.StatusForbidden,
		do(t, s, http.MethodPost, "/api/v1/test/translation-memory", ownerToken, memoryBody))
...
func TestPhase3_WorkspaceRoleOverride(t *testing.T) {
	...
	require.Equal(t, http.StatusForbidden,
		do(t, s, http.MethodPost, "/api/v1/test/translation-memory", memberToken, memoryBody))
