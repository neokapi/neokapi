...
func TestVoiceRollup_AggregatesAndIsolates(t *testing.T) {
	...
	call := func(ws, query string) VoiceRollupResponse {
		req := httptest.NewRequest(http.MethodGet, "/?"+query, nil)
		rec := httptest.NewRecorder()
		c := e.NewContext(req, rec)
		c.Set("workspace_id", ws)
		require.NoError(t, srv.HandleGetVoiceRollup(c))
		require.Equal(t, http.StatusOK, rec.Code)
		var resp VoiceRollupResponse
