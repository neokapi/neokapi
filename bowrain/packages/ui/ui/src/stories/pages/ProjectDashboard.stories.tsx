  ...
  args: {
    projects: [
      sampleProject,
      {
        ...
        items: [
          { name: "landing.html", format: "html", type: "file", size: 12000, block_count: 48, word_count: 320 },
          { name: "about.html", format: "html", type: "file", size: 8000, block_count: 32, word_count: 210 },
        ],
      ...
      },
      {
        ...
        items: [
          { name: "strings.xml", format: "xml", type: "file", size: 3200, block_count: 120, word_count: 650 },
        ],
