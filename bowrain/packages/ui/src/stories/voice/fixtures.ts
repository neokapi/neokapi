/**
 * Shared fixtures for voice Storybook stories.
 */
...
export const sampleScore: VoiceComplianceScore = {
  overall: 71,
...
export const excellentScore: VoiceComplianceScore = {
  overall: 93,
...
export const poorScore: VoiceComplianceScore = {
  overall: 27,
