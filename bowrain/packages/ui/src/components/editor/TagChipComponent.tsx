...
export function TagChipComponent({
  ...
  return (
    <span
      className={cn(
        "inline-flex items-center gap-0.5 px-1 mx-px rounded-sm border text-[11px] font-mono font-medium leading-[18px] align-middle cursor-default select-none whitespace-nowrap transition-[box-shadow,opacity] duration-150",
