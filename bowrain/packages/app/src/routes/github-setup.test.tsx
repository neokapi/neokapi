...
import { ApiProvider, AuthProvider, type ApiAdapter, type User, type Workspace } from "@neokapi/ui";
import { GithubSetupRoute } from "./github-setup";

// The route reads the installation id from the router's search params and
// navigates on import completion; neither needs a real router instance.
vi.mock("@tanstack/react-router", () => ({
  useSearch: () => ({ installation_id: 147350515 }),
  useNavigate: () => vi.fn(),
