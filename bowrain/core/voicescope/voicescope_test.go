...
func (f fakeWorkspaceDefault) WorkspaceVoiceProfileID(_ context.Context, _ string) (string, error) {
	return f.id, nil
}
...
func (f workspaceDefaultFunc) WorkspaceVoiceProfileID(ctx context.Context, workspaceID string) (string, error) {
