...
func TestEditorMemory(t *testing.T) {
	c, got := editorServer(t, map[string]route{
		"GET /api/v1/acme/content-memory":       {200, `{"entries":[{"id":"e1","source":"Hi","target":"Salut","source_language":"en","target_language":"fr","updated_at":"t"}],"total_count":1}`},
		"GET /api/v1/acme/content-memory/count": {200, `{"count":42}`},
		"POST /api/v1/acme/content-memory":      {201, `{"id":"e2","source":"Bye","target":"Au revoir","source_language":"en","target_language":"fr","updated_at":"t"}`},
		"PUT /api/v1/acme/content-memory/e2":    {204, ""},
		"DELETE /api/v1/acme/content-memory/e2": {204, ""},
	})
