...
func pinnedEventTypes() []struct {
	...
	return []struct {
		...
		{event.EventBrandVoiceCheckStarted, "brand.voice.check.started"},
		{event.EventBrandVoiceCheckCompleted, "brand.voice.check.completed"},
		{event.EventBrandVoiceGateFailed, "brand.voice.gate.failed"},
		{event.EventBrandVoiceGatePassed, "brand.voice.gate.passed"},
		{event.EventBrandVoiceDrift, "brand.voice.drift"},
		{event.EventBrandVoiceCorrected, "brand.voice.corrected"},
		{event.EventBrandProfileUpdated, "brand.profile.updated"},
