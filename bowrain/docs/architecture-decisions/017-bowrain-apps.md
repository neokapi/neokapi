...
([AD-005](005-connectors.md)) provide the integration; the desktop app
...
- [AD-003: Identity and Permissions](003-identity-and-permissions.md) — JWT, realms, roles
- [AD-005: Connectors](005-connectors.md) — content source abstraction
