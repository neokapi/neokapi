...
[Architecture Decisions](/docs/ad/index). This directory describes
...
protocols specific to bowrain) live in [Implementation Notes](/bowrain/notes/index).
...
| [010](010-bowrain-cli-and-project-model.md) | Bowrain CLI      | `.bowrain/` projects, config.yaml, hooks, MCP         |
