...
[AD-framework-013](../../../docs/architecture-decisions/013-cli-and-server.md),
...
- **`flows/*.yaml`** — hand-edited, committed. Same flow syntax as
  [AD-framework-006](../../../docs/architecture-decisions/006-tool-system.md).
...
([AD-framework-008](../../../docs/architecture-decisions/008-project-model.md))
...
- [AD-framework-008: Kapi Project Model](../../../docs/architecture-decisions/008-project-model.md) — `.kapi` files
- [AD-framework-013: Kapi CLI](../../../docs/architecture-decisions/013-cli-and-server.md) — shared CLI base
- [Bowrain Sync Protocol](/docs/notes/kapi-sync-protocol) — push/pull algorithms, cache format
- [CLI Commands Reference](/docs/notes/cli-commands-reference) — full command tree
