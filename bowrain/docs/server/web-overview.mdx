...
The web application and [Bowrain desktop app](/bowrain/desktop/overview) share the same core components (translation editor, TM explorer, terminology explorer) through the `@gokapi/ui` shared package. Key differences:
