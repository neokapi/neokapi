...
- [`bowrain diff`](/bowrain/cli/commands/diff) — Show detailed line-by-line changes
- [`bowrain pull`](/bowrain/cli/commands/pull) — Fetch changes from server
- [`bowrain push`](/bowrain/cli/commands/push) — Send local changes to server
