...
export class GraphArgs {
    /**
     * Creates a new GraphArgs instance.
     * @param {Partial<GraphArgs>} [$$source = {}] - The source object to create the GraphArgs.
     */
    constructor($$source = {}) {
        if (/** @type {any} */(false)) {
            /**
    ...
    /**
     * Creates a new GraphArgs instance from a string or object.
     * @param {any} [$$source = {}]
     * @returns {GraphArgs}
     */
    static createFrom($$source = {}) {
        let $$parsedSource = typeof $$source === 'string' ? JSON.parse($$source) : $$source;
        return new GraphArgs(/** @type {Partial<GraphArgs>} */($$parsedSource));
    }
}
