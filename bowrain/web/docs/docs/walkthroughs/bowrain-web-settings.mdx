...
> Generated from [`walkthroughs/bowrain-web-settings.md`](https://github.com/neokapi/neokapi/blob/main/bowrain/web/docs/walkthroughs/bowrain-web-settings.md). Do not edit by hand — change the prompt and regenerate.
