...
([AD-framework-011: AI Providers](https://neokapi.github.io/web/neokapi/docs/architecture/011-ai-providers)):
...
- [AD-framework-011: AI Providers](https://neokapi.github.io/web/neokapi/docs/architecture/011-ai-providers) — `LLMProvider` interface
- [AD-framework-010: Terminology](https://neokapi.github.io/web/neokapi/docs/architecture/010-terminology) — terminology pipeline
...
- [Translation Job Queue](/notes/translation-job-queue) — worker and quota details
- [Entity & Term Extraction](/notes/entity-term-extraction) — extraction pipeline internals
- [Brand Voice Data Model](/notes/brand-voice-data-model) — schema and resolution
