...
content memory, and terminology are shared and consistent across them — a
...
- [Voice & corrections](/server/context-voice) — how a reviewer's correction becomes a shared check
