...
A glossary and a translation memory are local files in kapi. Bowrain keeps them on the server, shared across every project and every translator in the workspace — one governed source of the team's approved wording, searchable and versioned.
