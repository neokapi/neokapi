...
The [content memory](/server/translation-memory) browser provides full access to the workspace content memory. Browse, search, add, edit, and delete entries. Filter by source or target locale.
