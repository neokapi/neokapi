...
The Terminology Explorer is the **Concepts** view of the [Context](/server/context)
...
Terminology and content memory are kept on the server, shared across every
...
2. **From the sidebar** — click **Brand** in the main sidebar, then **Concepts**, to reach the workspace-scoped explorer.
...
On the platform, the same concepts are the nodes of the [Context](/server/context)
