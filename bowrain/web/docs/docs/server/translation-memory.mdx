...
Translation memory and terminology live on the server, shared across every project and translator — searchable and versioned.
...
See [Translation Editor](./translation-editor.mdx) for details on context panel TM matching.
