...
On top of that, Bowrain **learns the profile from your team's corrections** and
keeps the result versioned, shared, and enforced — the governed layer the local
toolchain leaves to the platform (see [Kapi vs Bowrain](/getting-started/kapi-vs-bowrain)).
