...
presence, edits, reviews, terminology, and content memory are shared live
...
The native desktop client is a real-time working copy of the server — the same
dashboard, editor, and reviews as the browser.
...
truth**. The authoritative content, content memory, terminology, and project
