...
presence, edits, reviews, terms, and content memory are shared live across
both. The pages on workspaces, the hub, review, the editor, memory, terms, and
connectors apply to both clients; this page covers only what is **different**
about the desktop app.

The native desktop client is a real-time working copy of the server, with the
same dashboard, hub, editor, and reviews as the browser.
...
truth**. The authoritative content, content memory, terms, and project
...
| Context hub, review session, editor, memory & terms explorers | Yes | Yes |
...
Install via Homebrew (`brew install --cask neokapi/tap/bowrain`) or download a
build for your platform; the [installation page](/installation#bowrain-desktop)
carries the direct, version-pinned links for the current release.

## First sign-in

1. Launch Bowrain.
2. Open **Settings** and enter your server URL (for example `https://app.bowrain.cloud`).
