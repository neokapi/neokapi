...
Direct downloads for **Bowrain Desktop 1.2.0-rc16**:

**macOS** (Apple Silicon)
- **macOS arm64 (.dmg)** — [`bowrain-1.2.0-rc16-macOS-arm64.dmg`](https://github.com/neokapi/neokapi/releases/download/bowrain-v1.2.0-rc16/bowrain-1.2.0-rc16-macOS-arm64.dmg)

**Windows** (Authenticode-signed, portable zip)
- **Windows amd64** — [`bowrain-1.2.0-rc16-windows-amd64.zip`](https://github.com/neokapi/neokapi/releases/download/bowrain-v1.2.0-rc16/bowrain-1.2.0-rc16-windows-amd64.zip)
- **Windows arm64** — [`bowrain-1.2.0-rc16-windows-arm64.zip`](https://github.com/neokapi/neokapi/releases/download/bowrain-v1.2.0-rc16/bowrain-1.2.0-rc16-windows-arm64.zip)

**Linux**
- **Linux amd64 (tar.gz)** — [`bowrain-1.2.0-rc16-linux-amd64.tar.gz`](https://github.com/neokapi/neokapi/releases/download/bowrain-v1.2.0-rc16/bowrain-1.2.0-rc16-linux-amd64.tar.gz)
- **Linux arm64 (tar.gz)** — [`bowrain-1.2.0-rc16-linux-arm64.tar.gz`](https://github.com/neokapi/neokapi/releases/download/bowrain-v1.2.0-rc16/bowrain-1.2.0-rc16-linux-arm64.tar.gz)

Verify a download against [`checksums.txt`](https://github.com/neokapi/neokapi/releases/download/bowrain-v1.2.0-rc16/checksums.txt).
