    ...
    <section id="open-source" className="mx-auto max-w-6xl px-6 py-24">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <p className="mt-3 text-neutral-400">
          Bowrain builds on kapi, the Apache-2.0 open-source toolchain. kapi reads and writes
          localization, document, and data formats, chains tools into workflows, translates with AI,
          and keeps a translation memory — and it runs anywhere, with or without Bowrain. Bowrain
          hosts and governs that work for a team.
        </p>
      </div>
      ...
      <div className="mt-12 grid gap-6 md:grid-cols-2">
        <div className="rounded-xl border border-neutral-800 bg-neutral-900/30 p-6">
          ...
          <p className="text-sm leading-relaxed text-neutral-400">
            Readers and writers that distinguish text from variables and markup, across
            localization, document, data, subtitle, and office formats — from JSON and Markdown to
            DOCX, XLSX, IDML, and PDF.
          </p>
          <div className="mt-4 flex flex-wrap gap-1.5">
            {FORMATS_SAMPLE.map((f) => (
              <span
                key={f}
                className="rounded-md bg-neutral-800/70 px-2 py-0.5 text-xs text-neutral-400"
              >
                {f}
              </span>
            ))}
        ...
        <div className="rounded-xl border border-neutral-800 bg-neutral-900/30 p-6">
          ...
          <div className="mt-4 overflow-hidden rounded-lg border border-neutral-800 bg-neutral-950 p-4 font-mono text-xs text-neutral-400">
            ...
            <div>
              <span className="text-brand-400">steps</span>:
            </div>
            <div>
              {" "}
              - <span className="text-brand-400">segmenter</span>
            </div>
            <div>
              {" "}
            ...
            <div>
              {" "}
              - <span className="text-brand-400">term-lookup</span>
            </div>
            <div>
              {" "}
            ...
            <div>
              {" "}
              - <span className="text-brand-400">term-enforce</span>
            </div>
            <div>
              {" "}
        ...
        <div className="rounded-xl border border-neutral-800 bg-neutral-900/30 p-6">
          ...
          <p className="text-sm leading-relaxed text-neutral-400">
            AI translation runs in the same workflow as your glossary and past translations. Your
            preferred terms are sent to the model, so it uses your vocabulary rather than its own.
          ...
          <div className="mt-4 overflow-hidden rounded-lg border border-neutral-800 bg-neutral-950 p-4 font-mono text-xs">
            ...
            <div className="mt-1 text-neutral-400">
              <span className="text-brand-400">workspace</span> →{" "}
              <span className="text-neutral-300">Arbeitsbereich</span>{" "}
              <span className="text-neutral-600">(de)</span>
            </div>
            <div className="text-neutral-400">
              <span className="text-brand-400">dashboard</span> →{" "}
              <span className="text-neutral-300">Übersicht</span>{" "}
              <span className="text-neutral-600">(de)</span>
            </div>
            <div className="text-neutral-400">
              <span className="text-brand-400">deploy</span> →{" "}
              <span className="text-neutral-300">bereitstellen</span>{" "}
              <span className="text-neutral-600">(de)</span>
            </div>
        ...
        <div className="rounded-xl border border-neutral-800 bg-neutral-900/30 p-6">
          ...
          <p className="text-sm leading-relaxed text-neutral-400">
            Names, companies, and dates are recognized and set aside before matching, so a sentence
            you translated once gets reused even when those values change.
          </p>
          <div className="mt-4 space-y-2 text-xs">
            <div className="rounded-lg border border-neutral-800 bg-neutral-950 p-3">
              <div className="text-neutral-500">Already translated:</div>
              <div className="text-neutral-300">
                "<span className="text-brand-400">John</span> works at{" "}
                <span className="text-brand-400">Acme</span>"
              </div>
            </div>
            <div className="rounded-lg border border-suggestion/30 bg-suggestion/5 p-3">
              <div className="text-neutral-500">New source:</div>
              <div className="text-neutral-300">
                "<span className="text-suggestion">Alice</span> works at{" "}
                <span className="text-suggestion">Globex</span>"
              </div>
              <div className="mt-1 flex items-center gap-2">
                <span className="rounded-full bg-suggestion/20 px-2 py-0.5 text-suggestion font-mono">
                  100% match
                </span>
      ...
      <div className="mt-12 grid gap-6 md:grid-cols-3">
        <div className="rounded-xl border border-neutral-800 bg-neutral-900/30 p-6 text-center">
          ...
          <p className="mt-2 text-sm text-neutral-400">
            kapi and the neokapi framework it builds on are Apache-2.0. Inspect, fork, contribute,
            and run
            <code className="rounded bg-neutral-800 px-1 text-xs text-neutral-300"> kapi</code> on
            its own — without Bowrain.
          </p>
        </div>
        ...
        <div className="rounded-xl border border-neutral-800 bg-neutral-900/30 p-6 text-center">
          ...
          <p className="mt-2 text-sm text-neutral-400">
            The Bowrain platform is available under AGPL or a commercial license. Run it on your own
            infrastructure with full control of your data.
          </p>
        </div>
        ...
        <div className="rounded-xl border border-neutral-800 bg-neutral-900/30 p-6 text-center">
          ...
          <p className="mt-2 text-sm text-neutral-400">
            kapi is a single executable that needs no runtime to install. Your projects,
            terminology, and translation memory stay in open formats you can take elsewhere.
          </p>
        </div>
      </div>
    </section>
