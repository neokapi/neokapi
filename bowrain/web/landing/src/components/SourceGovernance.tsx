    ...
    <section className="mx-auto max-w-6xl px-6 py-24">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <p className="mt-3 text-neutral-400">
          Bowrain holds the brand voice profile, terminology, and translation memory in one place,
          applied the same way for every team member, every channel, and every AI tool — and kept
          current as people correct and refine it.
        </p>
      </div>
      ...
      <div className="mt-12 grid gap-6 md:grid-cols-3">
        <div className="rounded-xl border border-neutral-800 bg-neutral-900/30 p-6">
          ...
          <p className="mt-2 text-sm text-neutral-400">
            Preferred terms, forbidden words, competitor name handling. Applied consistently across
            every team member and every piece of content.
          </p>
        ...
        <div className="rounded-xl border border-neutral-800 bg-neutral-900/30 p-6">
          ...
          <p className="mt-2 text-sm text-neutral-400">
            Docs are precise. Marketing is warm. Support is empathetic. Same brand, different voice.
        ...
        <div className="rounded-xl border border-neutral-800 bg-neutral-900/30 p-6">
          ...
          <p className="mt-2 text-sm text-neutral-400">
            Human corrections feed back into the shared profile. Terminology and translation memory
            update once and apply to everyone, so the next suggestion reflects the team's prior
            decisions.
          </p>
          <div className="mt-4 space-y-2 text-xs">
      ...
      <div className="mx-auto mt-12 max-w-2xl rounded-xl border border-neutral-800 bg-neutral-900/30 p-6">
        <div className="mb-4 text-center text-sm font-medium text-white">
          Brand Compliance Score — Five Dimensions
        </div>
