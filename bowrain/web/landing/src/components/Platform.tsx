    ...
    <section id="platform" className="mx-auto max-w-6xl px-6 py-24">
      ...
      <div className="mt-12 grid gap-6 md:grid-cols-2">
        ...
        <div className="rounded-xl border border-neutral-800 bg-neutral-900/30 p-6">
          ...
          <p className="text-sm leading-relaxed text-neutral-400">
            Set up rules that react automatically. New content arrives — translation starts.
            Quality checks pass — your team gets notified. Bad translations get caught before they ship.
          </p>
          <div className="mt-4 overflow-hidden rounded-lg border border-neutral-800 bg-neutral-950 p-4 font-mono text-xs text-neutral-400">
            ...
            <div><span className="text-brand-400">on</span>: content.pushed</div>
            <div><span className="text-brand-400">run</span>:</div>
            <div>  - <span className="text-neutral-300">ai-translate</span> <span className="text-neutral-600"># translate new blocks</span></div>
            <div>  - <span className="text-neutral-300">qa-check</span>     <span className="text-neutral-600"># run quality checks</span></div>
            <div>  - <span className="text-neutral-300">notify</span>       <span className="text-neutral-600"># webhook on completion</span></div>
          </div>
        </div>
