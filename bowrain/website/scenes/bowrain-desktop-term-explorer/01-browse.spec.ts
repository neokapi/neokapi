/**
 * Walkthrough: bowrain-desktop-term-explorer
 * Scene 1: browse (desktop)
 *
 * Generated from bowrain/website/walkthroughs/bowrain-desktop-term-explorer.md.
...
test.describe("walkthrough: bowrain-desktop-term-explorer", () => {
