/**
 * Walkthrough: bowrain-desktop-visual-editor
 * Scene 1: visual (desktop)
 *
 * Generated from bowrain/website/walkthroughs/bowrain-desktop-visual-editor.md.
...
test.describe("walkthrough: bowrain-desktop-visual-editor", () => {
