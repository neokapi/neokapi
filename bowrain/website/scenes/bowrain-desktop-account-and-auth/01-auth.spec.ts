/**
 * Walkthrough: bowrain-desktop-account-and-auth
 * Scene 1: auth (desktop)
 *
 * Generated from bowrain/website/walkthroughs/bowrain-desktop-account-and-auth.md.
...
test.describe("walkthrough: bowrain-desktop-account-and-auth", () => {
  test.use({ viewport: { width: 1280, height: 800 } });

  // TODO(#425): seed via BowrainAPI; cleanup in afterAll.

  test("auth [scene]", async ({ page }) => {
