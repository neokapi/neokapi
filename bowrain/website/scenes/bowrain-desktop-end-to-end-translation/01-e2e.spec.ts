/**
 * Walkthrough: bowrain-desktop-end-to-end-translation
 * Scene 1: e2e (desktop)
 *
 * Generated from bowrain/website/walkthroughs/bowrain-desktop-end-to-end-translation.md.
...
test.describe("walkthrough: bowrain-desktop-end-to-end-translation", () => {
  test.use({ viewport: { width: 1280, height: 800 } });

  // TODO(#425): seed via BowrainAPI; cleanup in afterAll.

  test("e2e [scene]", async ({ page }) => {
