/**
 * Walkthrough: bowrain-desktop-tm-leverage
 * Scene 1: leverage (desktop)
 *
 * Generated from bowrain/website/walkthroughs/bowrain-desktop-tm-leverage.md.
...
test.describe("walkthrough: bowrain-desktop-tm-leverage", () => {
  test.use({ viewport: { width: 1280, height: 800 } });

  // TODO(#425): seed via BowrainAPI; cleanup in afterAll.

  test("leverage [scene]", async ({ page }) => {
