/**
 * Walkthrough: bowrain-desktop-flow-editor
 * Scene 1: flow (desktop)
 *
 * Generated from bowrain/website/walkthroughs/bowrain-desktop-flow-editor.md.
...
test.describe("walkthrough: bowrain-desktop-flow-editor", () => {
  test.use({ viewport: { width: 1280, height: 800 } });

  // TODO(#425): seed via BowrainAPI; cleanup in afterAll.

  test("flow [scene]", async ({ page }) => {
