/**
 * Walkthrough: bowrain-desktop-workspace-switcher
 * Scene 1: switch (desktop)
 *
 * Generated from bowrain/website/walkthroughs/bowrain-desktop-workspace-switcher.md.
...
test.describe("walkthrough: bowrain-desktop-workspace-switcher", () => {
  test.use({ viewport: { width: 1280, height: 800 } });

  // TODO(#425): seed via BowrainAPI; cleanup in afterAll.

  test("switch [scene]", async ({ page }) => {
