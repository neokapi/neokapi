/**
 * Walkthrough: bowrain-desktop-workspace-project-management
 * Scene 1: manage (desktop)
 *
 * Generated from bowrain/website/walkthroughs/bowrain-desktop-workspace-project-management.md.
...
test.describe("walkthrough: bowrain-desktop-workspace-project-management", () => {
  test.use({ viewport: { width: 1280, height: 800 } });

  // TODO(#425): seed via BowrainAPI; cleanup in afterAll.

  test("manage [scene]", async ({ page }) => {
