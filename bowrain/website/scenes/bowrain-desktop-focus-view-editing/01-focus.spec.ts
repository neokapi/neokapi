/**
 * Walkthrough: bowrain-desktop-focus-view-editing
 * Scene 1: focus (desktop)
 *
 * Generated from bowrain/website/walkthroughs/bowrain-desktop-focus-view-editing.md.
...
test.describe("walkthrough: bowrain-desktop-focus-view-editing", () => {
  test.use({ viewport: { width: 1280, height: 800 } });

  // TODO(#425): seed via BowrainAPI; cleanup in afterAll.

  test("focus [scene]", async ({ page }) => {
