...
#   bowrain/website/scenes/{walkthrough-id}/0N-{scene-id}.webm
#
# This script flat-copies them as:
#   bowrain/website/static/video/bowrain/{walkthrough-id}/0N-{scene-id}.webm
#
...
SCENES="$REPO_ROOT/bowrain/website/scenes"
STAGE="$REPO_ROOT/bowrain/website/static/video/bowrain"
