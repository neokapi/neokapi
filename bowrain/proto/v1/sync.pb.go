// sync.proto — Sync protocol messages (AD-038).
...
const file_proto_v1_sync_proto_rawDesc = "" +
	...
	"\rcontent_types\x18\x03 \x03(\tR\fcontentTypes\x12P\n" +
	"\vitem_hashes\x18\x04 \x03(\v2/.neokapi.server.v1.SyncPushInit.ItemHashesEntryR\n" +
	"itemHashes\x12\x1b\n" +
	...
	"\x14unchanged_item_count\x18\b \x01(\x05R\x12unchangedItemCount\"\xdd\x01\n" +
	"\fSyncItemDiff\x12\x1b\n" +
	"\tupload_id\x18\x01 \x01(\tR\buploadId\x12\x1b\n" +
	"\titem_name\x18\x02 \x01(\tR\bitemName\x12S\n" +
	"\fblock_hashes\x18\x03 \x03(\v20.neokapi.server.v1.SyncItemDiff.BlockHashesEntryR\vblockHashes\x1a>\n" +
	...
	"\ttransport\x18\x05 \x01(\tR\ttransport\"\xb7\x03\n" +
	"\fSyncManifest\x12\x1b\n" +
	"\tupload_id\x18\x01 \x01(\tR\buploadId\x12\x1d\n" +
	"\n" +
	"project_id\x18\x02 \x01(\tR\tprojectId\x12\x16\n" +
	"\x06stream\x18\x03 \x01(\tR\x06stream\x123\n" +
	"\x06chunks\x18\x04 \x03(\v2\x1b.neokapi.server.v1.ChunkRefR\x06chunks\x125\n" +
	"\x05items\x18\x05 \x03(\v2\x1f.neokapi.server.v1.SyncItemMetaR\x05items\x12\x19\n" +
	"\bactor_id\x18\x06 \x01(\tR\aactorId\x12%\n" +
	"\x0eworkspace_slug\x18\a \x01(\tR\rworkspaceSlug\x12!\n" +
	"\fconnector_id\x18\b \x01(\tR\vconnectorId\x12F\n" +
	"\acontext\x18\t \x03(\v2,.neokapi.server.v1.SyncManifest.ContextEntryR\acontext\x1a:\n" +
	...
	"\tbyte_size\x18\x05 \x01(\x03R\bbyteSize\"\xad\x02\n" +
	"\tSyncChunk\x12!\n" +
	"\fcontent_type\x18\x01 \x01(\tR\vcontentType\x12!\n" +
	"\frecord_count\x18\x02 \x01(\x05R\vrecordCount\x124\n" +
	"\x06blocks\x18\n" +
	" \x03(\v2\x1c.neokapi.server.v1.SyncBlockR\x06blocks\x121\n" +
	"\x05terms\x18\v \x03(\v2\x1b.neokapi.server.v1.SyncTermR\x05terms\x12=\n" +
	"\n" +
	"tm_entries\x18\f \x03(\v2\x1e.neokapi.server.v1.SyncTMEntryR\ttmEntries\x122\n" +
	"\x05media\x18\r \x03(\v2\x1c.neokapi.server.v1.SyncMediaR\x05media\"\xe5\a\n" +
	"\tSyncBlock\x12\x0e\n" +
	...
	"\ftranslatable\x18\x06 \x01(\bR\ftranslatable\x126\n" +
	"\x06source\x18\a \x03(\v2\x1e.neokapi.server.v1.SyncSegmentR\x06source\x12\x1f\n" +
	"\vsource_text\x18\b \x01(\tR\n" +
	"sourceText\x12C\n" +
	"\atargets\x18\t \x03(\v2).neokapi.server.v1.SyncBlock.TargetsEntryR\atargets\x12L\n" +
	"\n" +
	"properties\x18\n" +
	" \x03(\v2,.neokapi.server.v1.SyncBlock.PropertiesEntryR\n" +
	"properties\x12)\n" +
	...
	"\x10content_ref_json\x18\x0f \x01(\fR\x0econtentRefJson\x12V\n" +
	"\x0econnector_data\x18\x10 \x03(\v2/.neokapi.server.v1.SyncBlock.ConnectorDataEntryR\rconnectorData\x12#\n" +
	"\rexpected_hash\x18\x11 \x01(\tR\fexpectedHash\x12!\n" +
	"\fcontent_hash\x18\x12 \x01(\tR\vcontentHash\x1a^\n" +
	"\fTargetsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x128\n" +
	"\x05value\x18\x02 \x01(\v2\".neokapi.server.v1.SyncSegmentListR\x05value:\x028\x01\x1a=\n" +
	...
	"sourceTerm\x12#\n" +
	"\rsource_locale\x18\x03 \x01(\tR\fsourceLocale\x12J\n" +
	"\ftranslations\x18\x04 \x03(\v2&.neokapi.server.v1.SyncTermTranslationR\ftranslations\x12\x1e\n" +
	"\n" +
	"definition\x18\x05 \x01(\tR\n" +
	"definition\x12\x16\n" +
	"\x06domain\x18\x06 \x01(\tR\x06domain\x12K\n" +
	"\n" +
	"properties\x18\a \x03(\v2+.neokapi.server.v1.SyncTerm.PropertiesEntryR\n" +
	"properties\x12\x16\n" +
	...
	"\x06status\x18\x03 \x01(\tR\x06status\"\x89\x03\n" +
	...
	"\x05score\x18\a \x01(\x01R\x05score\x12N\n" +
	"\n" +
	"properties\x18\b \x03(\v2..neokapi.server.v1.SyncTMEntry.PropertiesEntryR\n" +
	"properties\x12!\n" +
	"\fcontent_hash\x18\t \x01(\tR\vcontentHash\x1a=\n" +
	"\x0fPropertiesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\x0fsource_media_id\x18\r \x01(\tR\rsourceMediaId\x12L\n" +
	"\n" +
	"properties\x18\x0e \x03(\v2,.neokapi.server.v1.SyncMedia.PropertiesEntryR\n" +
	"properties\x12!\n" +
	...
	"\x0fsource_language\x18\a \x01(\tR\x0esourceLanguage\x12Y\n" +
	"\x0econnector_data\x18\b \x03(\v22.neokapi.server.v1.SyncItemMeta.ConnectorDataEntryR\rconnectorData\x1a@\n" +
	"\x12ConnectorDataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\alocales\x18\x06 \x03(\tR\alocales\"\xa1\x02\n" +
	"\x10SyncPullResponse\x12\x16\n" +
	"\x06cursor\x18\x01 \x01(\x03R\x06cursor\x12\x19\n" +
	"\bhas_more\x18\x02 \x01(\bR\ahasMore\x124\n" +
	"\x06blocks\x18\n" +
	" \x03(\v2\x1c.neokapi.server.v1.SyncBlockR\x06blocks\x121\n" +
	"\x05terms\x18\v \x03(\v2\x1b.neokapi.server.v1.SyncTermR\x05terms\x12=\n" +
	"\n" +
...
var file_proto_v1_sync_proto_goTypes = []any{
	...
	(*SyncItemDiffResponse)(nil), // 3: neokapi.server.v1.SyncItemDiffResponse
	(*SyncManifest)(nil),         // 4: neokapi.server.v1.SyncManifest
	(*ChunkRef)(nil),             // 5: neokapi.server.v1.ChunkRef
	(*SyncChunk)(nil),            // 6: neokapi.server.v1.SyncChunk
