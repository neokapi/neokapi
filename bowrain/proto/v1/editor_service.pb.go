...
var file_bowrain_proto_v1_editor_service_proto_msgTypes = make([]protoimpl.MessageInfo, 57)
...
func file_bowrain_proto_v1_editor_service_proto_init() {
	...
	file_bowrain_proto_v1_editor_service_proto_msgTypes[50].OneofWrappers = []any{
