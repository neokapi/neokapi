...
See the [plugin model](../../web/docs/contribute/implementation/engine/plugin-model.md)
...
in the [plugin protocol](../../web/docs/contribute/implementation/engine/plugin-protocol-v1.md)
note.
