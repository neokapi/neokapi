...
func TestProseP0_mdx(t *testing.T)        { proseFormatPresence(t, "mdx") }
func TestProseP0_po(t *testing.T)         { proseFormatPresence(t, "po") }
func TestProseP0_properties(t *testing.T) { proseFormatPresence(t, "properties") }
