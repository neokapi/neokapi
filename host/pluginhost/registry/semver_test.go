...
func TestCompareSemver(t *testing.T) {
	cases := []struct {
		...
		{"1.4.0-rc1", "1.4.0", -1},  // a release outranks its own pre-releases
		{"1.2.0-rc7", "1.2.0-rc17", -1}, // numeric tails order numerically
		{"1.2.0-rc17", "1.2.0-rc17", 0},
		{"1.2.0-beta", "1.2.0-rc1", -1}, // alpha prefixes order lexically
