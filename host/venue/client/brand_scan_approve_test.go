...
func TestApproveBrandScan(t *testing.T) {
	var gotPath, gotMethod string
	var gotBody BrandScanApproval
	...
	res, err := c.ApproveBrandScan(context.Background(), "scan-1", BrandScanApproval{
		Profile: BrandProfileUpsert{Name: "Acme Voice"},
		Locale:  "en-US",
		Terms:   []BrandScanApprovedTerm{{Term: "sign in", Domain: "auth"}, {Term: "cart"}},
	})
...
func TestApproveBrandScanForbidden(t *testing.T) {
	...
	_, err := c.ApproveBrandScan(context.Background(), "scan-1", BrandScanApproval{})
	require.ErrorIs(t, err, ErrForbidden)
}

func TestApproveBrandScanRequiresWorkspace(t *testing.T) {
