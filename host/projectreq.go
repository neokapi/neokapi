...
func lookupPluginInfo(ctx context.Context, indexURL, name, constraint, channel, kapiVer string) pluginPromptInfo {
	...
	if v, _, err := idx.Resolve(name, constraint, channel, kapiVer); err == nil {
		out.Version = v
