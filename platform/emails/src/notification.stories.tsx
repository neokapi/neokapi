...
export const FlowFailed: Story = {
  args: {
    ...
    body: "The auto-translate flow for Japanese in the Mobile App project failed after processing 42 of 128 strings. The MT provider returned a rate-limit error. You can retry the flow or switch to a different provider.",
    category: "Automation",
    priority: "high",
...
export const DeadlineApproaching: Story = {
  args: {
    ...
    body: "The task \"Review mobile strings\" for ja-JP is due in less than 24 hours. There are 42 strings remaining to review. Please complete your review to avoid delays in the release schedule.",
    category: "Task",
    priority: "high",
...
export const TaskAssigned: Story = {
  args: {
    ...
    body: "Alice assigned you to review 24 strings in fr-FR for the Mobile App project. The strings are part of the new onboarding flow and include UI labels and help text.",
    category: "Task",
    priority: "normal",
...
export const ContentAvailable: Story = {
  args: {
    ...
    body: "12 new strings have been pushed to the Mobile App project. The content includes updated checkout flow labels and error messages. These strings are ready for translation into your assigned languages.",
    category: "Project",
    priority: "normal",
