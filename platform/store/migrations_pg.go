...
// storeMigrationsPg defines the PostgreSQL content store schema as a single
// migration. This is the canonical schema — there are no incremental migrations
// to maintain since we start from scratch.
