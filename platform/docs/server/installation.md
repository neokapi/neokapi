...
- [Configuration](/bowrain/server/configuration) — all environment variables and CLI flags
- [Getting Started](/bowrain/server/getting-started) — first login, workspaces, invitations
- [Self-Hosting](/bowrain/server/self-hosting) — production deployment with TLS and backups
