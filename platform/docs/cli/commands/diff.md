...
- [`bowrain status`](/bowrain/cli/commands/status) — Show which files changed (summary)
- [`bowrain pull`](/bowrain/cli/commands/pull) — Fetch remote changes
- [`bowrain push`](/bowrain/cli/commands/push) — Send local changes
