...
const sampleProject: ProjectInfo = {
  ...
  items: [
    ...
    { id: "itm-abt", name: "about.json", format: "json", type: "file", size: 4200, block_count: 22, word_count: 280 },
    { id: "itm-faq", name: "faq.md", format: "md", type: "file", size: 8000, block_count: 35, word_count: 620 },
    { id: "itm-prc", name: "pricing.xliff", format: "xliff", type: "file", size: 6000, block_count: 18, word_count: 190 },
  ],
  streams: [
    ...
    { name: "q1-campaign", parent: "main", base_cursor: 5, archived: false, visibility: "public", description: "Q1 campaign", created_at: "2026-02-01T10:00:00Z", created_by: "user-1" },
    { name: "review/alice", parent: "main", base_cursor: 3, archived: false, visibility: "shared", description: "Alice's review", created_at: "2026-03-01T10:00:00Z", created_by: "user-2", shared_with: ["user-1"] },
  ],
