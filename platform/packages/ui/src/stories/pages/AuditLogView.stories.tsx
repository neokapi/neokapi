...
const sampleEntries: AuditEntry[] = [
  {
    ...
    source: "web",
    data: JSON.stringify({ name: "Marketing Website" }),
    created_at: ago(5),
  },
  {
    id: 2,
    ...
    actor: "alice@example.com",
    source: "web",
    data: JSON.stringify({ item_name: "locales/en.json", stream: "main", format: "json" }),
    created_at: ago(4),
  },
  {
    id: 3,
    ...
    source: "editor",
    data: JSON.stringify({ block_id: "abc12345-def6-7890", item_name: "locales/en.json" }),
    created_at: ago(3),
  },
  {
    id: 4,
    ...
    actor: "alice@example.com",
    source: "web",
    data: JSON.stringify({ stream: "feature/translations", parent: "main" }),
    created_at: ago(2),
  },
  {
    id: 5,
    ...
    actor: "ci-bot",
    source: "sync",
    data: JSON.stringify({ items: "src/i18n/en.json,src/i18n/common.json", push_id: "push-001" }),
    created_at: ago(90),
  },
];
