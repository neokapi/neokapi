...
export const sampleLocaleStats: LocaleTranslationStats[] = [
  { locale: "fr-FR", percentage: 85.2, translated_words: 4260, total_words: 5000, translated_blocks: 170, total_blocks: 200 },
  { locale: "de-DE", percentage: 62.0, translated_words: 3100, total_words: 5000, translated_blocks: 124, total_blocks: 200 },
  { locale: "ja-JP", percentage: 45.5, translated_words: 2275, total_words: 5000, translated_blocks: 91, total_blocks: 200 },
  { locale: "es-ES", percentage: 92.0, translated_words: 4600, total_words: 5000, translated_blocks: 184, total_blocks: 200 },
];

export const sampleItemStats: ItemTranslationStats[] = [
  {
    item_id: "itm-1", item_name: "landing.html", format: "html", word_count: 1320, collection_id: "coll-default", block_count: 48,
    locales: [
      { locale: "fr-FR", percentage: 95, translated_words: 1254, total_words: 1320, translated_blocks: 46, total_blocks: 48 },
      { locale: "de-DE", percentage: 70, translated_words: 924, total_words: 1320, translated_blocks: 34, total_blocks: 48 },
    ],
  },
  {
    item_id: "itm-2", item_name: "about.json", format: "json", word_count: 640, collection_id: "coll-default", block_count: 20,
    locales: [
      { locale: "fr-FR", percentage: 100, translated_words: 640, total_words: 640, translated_blocks: 20, total_blocks: 20 },
      { locale: "de-DE", percentage: 50, translated_words: 320, total_words: 640, translated_blocks: 10, total_blocks: 20 },
    ],
  },
  {
    item_id: "itm-3", item_name: "api-reference.md", format: "md", word_count: 3040, collection_id: "coll-docs", block_count: 80,
    locales: [
      { locale: "fr-FR", percentage: 78, translated_words: 2371, total_words: 3040, translated_blocks: 62, total_blocks: 80 },
      { locale: "de-DE", percentage: 30, translated_words: 912, total_words: 3040, translated_blocks: 24, total_blocks: 80 },
    ],
  },
];
...
export const sampleCollectionStats: CollectionTranslationStats[] = [
  {
    collection_id: "coll-default", collection_name: "Default", item_count: 3, block_count: 148, word_count: 5000,
    locales: [
      { locale: "fr-FR", percentage: 85, translated_words: 4250, total_words: 5000, translated_blocks: 128, total_blocks: 148 },
      { locale: "de-DE", percentage: 52, translated_words: 2600, total_words: 5000, translated_blocks: 68, total_blocks: 148 },
    ],
  },
  {
    collection_id: "coll-docs", collection_name: "Documentation", item_count: 8, block_count: 120, word_count: 12000,
    locales: [
      { locale: "fr-FR", percentage: 60, translated_words: 7200, total_words: 12000, translated_blocks: 72, total_blocks: 120 },
      { locale: "de-DE", percentage: 25, translated_words: 3000, total_words: 12000, translated_blocks: 30, total_blocks: 120 },
    ],
  },
];
