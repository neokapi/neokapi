...
export const mockTerms = [
  {
    id: "t-1",
    term: "workspace",
    definition: "A top-level organizational unit containing projects",
    locale: "en-US",
    domain: "product",
  },
  {
    id: "t-2",
    term: "stream",
    definition: "A named branch of content within a project",
    locale: "en-US",
    domain: "technical",
  },
  {
    id: "t-3",
    term: "collection",
    definition: "A group of items within a project",
    locale: "en-US",
    translations: { "fr-FR": "collection", "de-DE": "Sammlung" },
  },
];
