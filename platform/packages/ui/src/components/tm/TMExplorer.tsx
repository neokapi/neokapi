    ...
    <div data-testid="tm-explorer">
      <Card className="p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <Button onClick={() => setShowAddForm(true)} data-testid="tm-add-entry-btn">
            Add Entry
          </Button>
        </div>
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="border-b border-border">
                    ...
                    <th className="px-4 py-2.5 text-sm font-medium text-muted-foreground w-[120px]">
                      Actions
                    </th>
                  </tr>
                </thead>
                  ...
                  {entries.map((entry) => (
                    ...
                    >
                      <td
                        ...
                        data-testid={`tm-source-${entry.id}`}
                      >
                        {entry.source}
                      </td>
                      <td
                        className="px-4 py-2.5 text-sm text-muted-foreground"
                        data-testid={`tm-target-${entry.id}`}
                      >
                        {editingId === entry.id ? (
            ...
            {totalPages > 1 && (
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-muted-foreground" data-testid="tm-page-info">
