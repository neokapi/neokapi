...
| **tree-sitter** runtime (go-tree-sitter) and grammars (Ruby, TypeScript, JavaScript, Python, Bash, CSS, Rust, Java, C#, C, C++) | `kapi-sourcecode` | MIT | compiled into the plugin binary | attribution; `NOTICE` in the tarball |
