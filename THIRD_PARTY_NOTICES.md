...
| **tree-sitter** runtime (go-tree-sitter) and grammars (Ruby, TypeScript, JavaScript) | `kapi-sourcecode` | MIT | compiled into the plugin binary | attribution; `NOTICE` in the tarball |
