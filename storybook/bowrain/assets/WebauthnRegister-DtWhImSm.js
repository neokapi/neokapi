import{a as e,n as t}from"./chunk-DnJy8xQt.js";import{t as n}from"./react-Baqbuk-D.js";import{t as r}from"./jsx-runtime-B-hFyic3.js";import{t as i}from"./label-HrqY8KiI.js";import{t as a}from"./button-MBstDm8k.js";import{a as o,o as s,r as c,t as l}from"./card-p3PnhtGK.js";import{t as u}from"./iframe-BJVhYAGS.js";import{n as d,t as f}from"./useInsertScriptTags-DyG7n_Te.js";import{n as p,t as m}from"./waitForElementMountedOnDom-C7bQRbIB.js";function h(){let e=navigator.userAgent,t=`Browser`,n=`Device`;return e.includes(`Chrome`)&&!e.includes(`Edg`)?t=`Chrome`:e.includes(`Edg`)?t=`Edge`:e.includes(`Safari`)&&!e.includes(`Chrome`)?t=`Safari`:e.includes(`Firefox`)&&(t=`Firefox`),e.includes(`Mac OS`)?n=`macOS`:e.includes(`Windows`)?n=`Windows`:e.includes(`Linux`)&&!e.includes(`Android`)?n=`Linux`:e.includes(`Android`)?n=`Android`:(e.includes(`iPhone`)||e.includes(`iPad`))&&(n=`iOS`),`${t} on ${n}`}function g(e){let{authButtonId:t,kcContext:n,i18n:r}=e,{url:i,challenge:a,userid:o,username:s,signatureAlgorithms:c,rpEntityName:l,rpId:u,attestationConveyancePreference:f,authenticatorAttachment:m,requireResidentKey:g,userVerificationRequirement:v,createTimeout:y,excludeCredentialIds:b}=n,{isFetchingTranslations:x}=r,S=h(),{insertScriptTags:C}=d({componentOrHookName:`WebauthnRegisterAutoLabel`,scriptTags:[{type:`module`,textContent:()=>`
