...
// Store extends TranslationMemory with search, stream, import-session,
...
type Store interface {
	...
	// AddWithStream inserts or updates a content-memory entry associated with a stream.
	// The stream is a persistence concern (e.g., a git branch name).
	AddWithStream(ctx context.Context, entry Entry, stream string) error
	...
	SearchEntries(ctx context.Context, params SearchParams) ([]Entry, int, error)
	...
	SearchEntriesFiltered(ctx context.Context, params SearchParams) ([]Entry, int, error)
	...
	SearchEntriesForStream(ctx context.Context, params SearchParams) ([]Entry, int, error)
