...
func (a *App) RunFlowAllLocales(ctx context.Context, opts FlowRunOptions, sink RunEventSink) (*FlowRunResult, error) {
	...
	cmd := &cobra.Command{Use: "flow-run"}
	AddProjectFlag(cmd)
	if opts.ProjectPath != "" {
...
func (a *App) buildProjectFlowTools(cmd *cobra.Command, flowName string, spec *flow.StepsSpec, rCtx *flow.ResourceContext, onProgress func(aiprovider.ProgressEvent)) ([]tool.Tool, func(), error) {
