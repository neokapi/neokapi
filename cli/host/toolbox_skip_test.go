...
func TestRunCatContinuesPastBadFile(t *testing.T) {
	...
	out, err := captureStdout(t, func() error {
		return app.RunCat(context.Background(), NewEnvCommand(context.Background(), "test"), args, CatOptions{})
	})
...
func TestRunCatGlobWithOnlyJunkAndGood(t *testing.T) {
	...
	out, err := captureStdout(t, func() error {
		return app.RunCat(context.Background(), NewEnvCommand(context.Background(), "test"), []string{lock, good}, CatOptions{})
	})
