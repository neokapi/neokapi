...
// runMemoryExport drives the real `kapi tm export` RunE against the given db.
...
// runMemoryImport drives the real `kapi tm import` RunE against the given db.
...
// TestTermsKTZRoundTrip mirrors TestMemoryKMZRoundTrip for the terms.
