...
The gokapi web application is a browser-based translation workbench that provides the same powerful editing experience as the [Bowrain desktop app](/docs/bowrain-desktop/overview), accessible from any modern browser. It runs as part of `bowrain-server` for multi-user SaaS deployments, or as part of `kapi serve` for local single-user workflows.
...
<ThemedImage
  ...
  sources={{
    ...
    dark: '/img/web-app/glass/login.png',
  }}
/>
...
<ThemedImage
  ...
  sources={{
    ...
    dark: '/img/web-app/glass/workspace-rail.png',
  }}
/>
...
<ThemedImage
  ...
  sources={{
    ...
    dark: '/img/web-app/glass/dashboard.png',
  }}
/>
...
<ThemedImage
  ...
  sources={{
    ...
    dark: '/img/web-app/glass/project-view.png',
  }}
/>
...
<ThemedImage
  ...
  sources={{
    ...
    dark: '/img/web-app/glass/editor.png',
  }}
/>
...
<ThemedImage
  ...
  sources={{
    ...
    dark: '/img/web-app/glass/editor-focus.png',
  }}
/>
...
<ThemedImage
  ...
  sources={{
    ...
    dark: '/img/web-app/glass/context-panel.png',
  }}
/>
...
<ThemedImage
  ...
  sources={{
    ...
    dark: '/img/web-app/glass/tm-explorer.png',
  }}
/>
...
<ThemedImage
  ...
  sources={{
    ...
    dark: '/img/web-app/glass/term-explorer.png',
  }}
/>
...
<ThemedImage
  ...
  sources={{
    ...
    dark: '/img/web-app/glass/settings.png',
  }}
/>
