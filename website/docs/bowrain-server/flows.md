...
The most common way to run server-side flows is through automation rules. See [Automation](/docs/bowrain-server/automation) for details on creating rules.
...
This is managed automatically by the automation system. Loop prevention ensures chains cannot exceed 5 levels deep (see [Automation > Loop Prevention](/docs/bowrain-server/automation#loop-prevention)).

## Related

- [Automation](/docs/bowrain-server/automation) — event-driven automation rules
- [Translation Flows (CLI)](/docs/bowrain-cli/flows/overview) — local flow execution
