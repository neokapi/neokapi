...
- **A proper exchange format** — KLF/KLF (see [AD-008](/docs/ad/008-project-model)) — that carries structural context, placeholders, plural forms, and annotation sidecars. Not a flat key-value JSON.
