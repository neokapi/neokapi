...
| Format | Flat JSON / XLIFF | KLF/KLZ with structural context, placeholders, plural forms |
...
| Format | Flat JSON / PO | KLF/KLZ with structural context, placeholders, plural forms |
