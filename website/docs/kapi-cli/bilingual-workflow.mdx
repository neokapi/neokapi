...
Interop](/docs/architecture/017-bilingual-format-interop).
...
- [AD-009: Translation Memory](/docs/architecture/009-translation-memory) —
  matching tiers, TM schema, `LookupSegment` for sentence-level
  leverage
- [AD-008: Project Model](/docs/architecture/008-project-model) —
  `.kapi/extractions/<id>/` layout and `merge.conflict_policy` recipe
  shape
- [AD-013: Kapi CLI](/docs/architecture/013-kapi-cli) — command tree and
