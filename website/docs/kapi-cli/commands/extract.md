...
Interop](/docs/ad/017-bilingual-format-interop); the full
...
| `--format <name>` | `xliff2` | Output bilingual format. `xliff2` is feature-complete today; `po` is tracked as a follow-up. |
...
stay stable through the vendor round-trip.
