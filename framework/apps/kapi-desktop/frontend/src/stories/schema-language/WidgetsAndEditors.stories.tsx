...
const meta: Meta<typeof SchemaStory> = {
  title: "Schema Language/Widgets & Editors",
  ...
  args: {
    ...
    schema: {
      ...
      properties: {
        ...
        description: { type: "string", title: "Description", "x-widget": "text", "x-placeholder": "Enter a description..." },
      },
    },
  },
};
    ...
    schema: {
      ...
      properties: {
        apiKey: {
          ...
          "x-editor": { widget: "text", text: { password: true } },
        },
      },
    },
  },
    ...
    schema: {
      ...
      properties: {
        lineBreak: {
          ...
          default: "platform",
          "x-editor": { widget: "dropdown" },
          "x-enumLabels": { lf: "Unix (LF)", crlf: "Windows (CRLF)", platform: "Platform Default" },
        },
      },
    },
  },
