...
const meta: Meta = {
  title: "Formats & Tools/Formats/YAML Format",
...
export const NativeConfig: Story = {
  ...
  render: () => <ConfigEditor schemaName="yaml" source="builtIn" />,
};
export const OkapiConfig: Story = {
  name: "Okapi Configuration",
  render: () => <ConfigEditor schemaName="okf_yaml" source="bridge" />,
};
export const Compare: Story = {
  name: "Side by Side",
  render: () => <CompareEditor nativeName="yaml" okapiName="okf_yaml" />,
};
