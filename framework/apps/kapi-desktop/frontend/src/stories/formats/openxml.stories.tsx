...
const meta: Meta = {
  title: "Formats & Tools/Formats/Office Open XML Format",
...
export const NativeConfig: Story = {
  ...
  render: () => <ConfigEditor schemaName="openxml" source="builtIn" />,
};
export const OkapiConfig: Story = {
  name: "Okapi Configuration",
  render: () => <ConfigEditor schemaName="okf_openxml" source="bridge" />,
};
export const Compare: Story = {
  name: "Side by Side",
  render: () => <CompareEditor nativeName="openxml" okapiName="okf_openxml" />,
};
