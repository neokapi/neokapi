...
const meta: Meta = {
  title: "Formats & Tools/Formats/XLIFF 2.0",
...
export const NativeConfig: Story = {
  ...
  render: () => <ConfigEditor schemaName="xliff2" source="builtIn" />,
};
export const OkapiConfig: Story = {
  name: "Okapi Configuration",
  render: () => <ConfigEditor schemaName="okf_xliff2" source="bridge" />,
};
export const Compare: Story = {
  name: "Side by Side",
  render: () => <CompareEditor nativeName="xliff2" okapiName="okf_xliff2" />,
};
