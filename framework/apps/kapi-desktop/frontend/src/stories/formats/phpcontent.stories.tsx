...
const meta: Meta = {
  title: "Formats & Tools/Formats/PHP Content",
...
export const NativeConfig: Story = {
  ...
  render: () => <ConfigEditor schemaName="phpcontent" source="builtIn" />,
};
export const OkapiConfig: Story = {
  name: "Okapi Configuration",
  render: () => <ConfigEditor schemaName="okf_phpcontent" source="bridge" />,
};
export const Compare: Story = {
  name: "Side by Side",
  render: () => <CompareEditor nativeName="phpcontent" okapiName="okf_phpcontent" />,
};
