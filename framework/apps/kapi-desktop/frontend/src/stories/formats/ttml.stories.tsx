...
const meta: Meta = {
  title: "Formats & Tools/Formats/TTML Subtitles",
...
export const NativeConfig: Story = {
  ...
  render: () => <ConfigEditor schemaName="ttml" source="builtIn" />,
};
export const OkapiConfig: Story = {
  name: "Okapi Configuration",
  render: () => <ConfigEditor schemaName="okf_ttml" source="bridge" />,
};
export const Compare: Story = {
  name: "Side by Side",
  render: () => <CompareEditor nativeName="ttml" okapiName="okf_ttml" />,
};
