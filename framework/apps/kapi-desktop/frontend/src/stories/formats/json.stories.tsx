...
const meta: Meta = {
  title: "Formats & Tools/Formats/JSON Format",
...
export const NativeConfig: Story = {
  ...
  render: () => <ConfigEditor schemaName="json" source="builtIn" />,
};
export const OkapiConfig: Story = {
  name: "Okapi Configuration",
  render: () => <ConfigEditor schemaName="okf_json" source="bridge" />,
};
export const Compare: Story = {
  name: "Side by Side",
  render: () => <CompareEditor nativeName="json" okapiName="okf_json" />,
};
