...
func TestTranslateToolBatchAccumulatesUsage(t *testing.T) {
	...
	mock.ChatStructuredFunc = func(ctx context.Context, messages []provider.Message, schema provider.JSONSchema) (*provider.ChatResponse, error) {
		return &provider.ChatResponse{
			...
			Model:   "test",
			Usage:   provider.TokenUsage{InputTokens: 500, OutputTokens: 200},
		}, nil
	}
...
func TestQAToolAccumulatesUsage(t *testing.T) {
	...
	mock.ChatStructuredFunc = func(ctx context.Context, messages []provider.Message, schema provider.JSONSchema) (*provider.ChatResponse, error) {
		return &provider.ChatResponse{
			Content: `{"issues":[]}`,
			Model:   "test",
			Usage:   provider.TokenUsage{InputTokens: 200, OutputTokens: 30},
		}, nil
	}
...
func TestReviewToolAccumulatesUsage(t *testing.T) {
	...
	mock.ChatFunc = func(ctx context.Context, messages []provider.Message) (*provider.ChatResponse, error) {
		return &provider.ChatResponse{
			Content: "Score: 9\nAssessment: Good",
			Model:   "test",
			Usage:   provider.TokenUsage{InputTokens: 150, OutputTokens: 25},
		}, nil
	}
...
func TestTerminologyToolAccumulatesUsage(t *testing.T) {
	...
	mock.ChatStructuredFunc = func(ctx context.Context, messages []provider.Message, schema provider.JSONSchema) (*provider.ChatResponse, error) {
		return &provider.ChatResponse{
			Content: `{"terms":[]}`,
			Model:   "test",
			Usage:   provider.TokenUsage{InputTokens: 80, OutputTokens: 15},
		}, nil
	}
