...
| Skeleton store binary format | `web/docs/contribute/implementation/engine/skeleton-store.md` |
| Maturity rubric + levels + audit procedure | `docs/internals/format-maturity.md` |

> The older `web/docs/contribute/implementation/engine/implementing-formats.md`
