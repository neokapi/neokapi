...
- **SkeletonStore streaming** (HTML, XML). A temp-file-backed binary
  ...
  [Skeleton Store](/docs/notes/skeleton-store) for the binary format and
  wiring.
...
See [Implementing Formats](/docs/notes/implementing-formats) for a
walkthrough, and [Skeleton Store](/docs/notes/skeleton-store) for the
...
- [Implementing Formats](/docs/notes/implementing-formats) — implementation walkthrough
- [Skeleton Store](/docs/notes/skeleton-store) — binary skeleton format and wiring
