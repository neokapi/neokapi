...
const multiBlockParts: Record<string, PartSnapshotSet> = {
  ...
  p2: {
    initial: { id: "p2", type: "Block", summary: "Click here", sourceText: "Click here", targetText: "Click here" },
    afterNode: {
  ...
  p3: {
    ...
    afterNode: {
      "tool-0": { id: "p3", type: "Block", summary: "Submit form", sourceText: "Submit form", targetText: "Soumettre le formulaire" },
    },
  },
};
