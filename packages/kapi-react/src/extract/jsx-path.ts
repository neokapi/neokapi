 ...
 *
 * v2 semantics: the descriptor is the element's OWN resolved tag
 * only — `"p"`, `"button"`, `"fragment"`. Ancestors are deliberately
 ...
 *
 * The v1 full-ancestor-path builder is frozen in
