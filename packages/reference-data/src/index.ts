...
// okapi-bridge formats and tools. Regenerate with `make generate-reference-docs`
// (scripts/gen-refs). Do not edit the JSON under data/ by hand.

import formatsJson from "../data/formats.json";
import toolsJson from "../data/tools.json";
import gapsJson from "../data/reference-gaps.json";
import type { ReferenceDataset, ReferenceEntry, ReferenceGapReport } from "./types";
