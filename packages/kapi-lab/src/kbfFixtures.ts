...
/** The KBF samples offered in the Lab's sample picker. */
export const KBF_SAMPLES: KbfSample[] = [
  {
    id: "full",
...
// ─── Annotation overlay (.overlays.jsonl) ──────────────────────────────────────────
...
export const ANNOTATIONS_KBFL = [
  ...
  JSON.stringify({
    ...
    id: "term-1",
    block: "tag-chip",
    anchor: { kind: "run", path: [2], runId: "2" },
