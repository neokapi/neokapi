...
const ws1: Workspace = { id: "1", name: "Acme", slug: "acme", description: "", logo_url: "", role: "owner" };
const ws2: Workspace = { id: "2", name: "Beta", slug: "beta", description: "", logo_url: "", role: "member" };
