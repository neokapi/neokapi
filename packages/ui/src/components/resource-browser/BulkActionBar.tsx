...
export function BulkActionBar({
  ...
  return (
    <div
      className={`fixed bottom-4 left-1/2 -translate-x-1/2 z-40 flex items-center gap-3 rounded-lg border border-border bg-card px-4 py-2.5 shadow-lg ${className ?? ""}`}
