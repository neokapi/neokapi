...
describe("integration: recommended-strict fires on every mistake", () => {
  it("flags one issue per rule in the fixture", () => {
    ...
    const messages = linter.verify(code, [
      {
        ...
        plugins: { "neokapi-i18n": plugin as unknown as ESLint.Plugin },
    ...
    const ruleIds = messages
      ...
      .sort();
    const expected = [
      "neokapi-i18n/no-concat-in-translatable-attr",
      "neokapi-i18n/no-concat-in-translatable-attr",
      "neokapi-i18n/no-string-literal-jsx-expr",
      "neokapi-i18n/prefer-t-for-label-props",
      "neokapi-i18n/prefer-t-for-label-props",
      "neokapi-i18n/t-literal-first-arg",
      "neokapi-i18n/t-no-concat",
      "neokapi-i18n/t-no-concat",
    ].sort();
