...
/**
 * @neokapi/i18n-react runtime — thin translation layer for OTA mode.
 *
...
export function __tx(
  ...
  if (
    ...
    console.warn(
      `[neokapi-i18n] translation for "${hash}" has element markers that don't match the call site; ` +
 ...
 * translations.
 *
 * The neokapi-i18n plugin rewrites every `t(...)` call bound to
 * `@neokapi/i18n-react/runtime` into a hash-based lookup at build
