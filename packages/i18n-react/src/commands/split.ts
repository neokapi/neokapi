...
const usage = `
Usage: neokapi-i18n split [options]
...
Options:
  ...
  --locales <dir>     Directory containing master {locale}.json dicts
                      produced by \`neokapi-i18n compile\` (required).
