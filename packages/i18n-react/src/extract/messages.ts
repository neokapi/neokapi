 ...
 *
 * The `t` export on `@neokapi/i18n-react/runtime` marks a string
 ...
 * like `import { t as _ } from '@neokapi/i18n-react/runtime'`.
...
const RUNTIME_IMPORT = "@neokapi/i18n-react/runtime";
