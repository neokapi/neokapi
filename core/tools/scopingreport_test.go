...
func TestScopingReportToolRepetition(t *testing.T) {
	...
	block.SetAnno(string(model.AnnoRepetition), &tools.RepetitionFacet{Status: "repetition"})
...
func TestScopingCollector(t *testing.T) {
	...
	block1.SetAnno(string(model.AnnoWordCount), &tools.WordCountFacet{Source: 3})
	...
	block3.SetAnno(string(model.AnnoWordCount), &tools.WordCountFacet{Source: 3})
