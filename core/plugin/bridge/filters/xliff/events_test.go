...
func TestRoundTrip_DoubleExtractionSdlXliff(t *testing.T) {
	fileRoundtripEvents(t, "okf_xliff/sdlxliff/simpleTest15984.sdlxliff", nil)
}

// okapi: XLIFFFilterTest#testDoubleExtractionSdlXliffAll
func TestRoundTrip_DoubleExtractionSdlXliffAll(t *testing.T) {
	fileRoundtripEvents(t, "okf_xliff/sdlxliff/test1.docx.sdlxliff", nil)
}
...
func TestRoundTrip_DoubleExtractionWithCustomElements(t *testing.T) {
	fileRoundtripEvents(t, "okf_xliff/addingElements.xlf", nil)
}
...
func TestRoundTrip_DoubleExtractionWithMultiAltTrans(t *testing.T) {
	fileRoundtripEvents(t, "okf_xliff/Manual-12-AltTrans.xlf", nil)
}

// okapi: XLIFFFilterTest#testDoubleExtractionIwsXliffAll
func TestRoundTrip_DoubleExtractionIwsXliffAll(t *testing.T) {
	fileRoundtripEvents(t, "okf_xliff/iwsxliff/test1_es.iwsxliff", nil)
}
...
func TestRoundTrip_DoubleExtractionIwsXliffAllPending(t *testing.T) {
	fileRoundtripEvents(t, "okf_xliff/iwsxliff/test2_es.iwsxliff", nil)
}
...
func TestRoundTrip_DoubleExtractionIwsXliffAllPendingNotLocked(t *testing.T) {
	fileRoundtripEvents(t, "okf_xliff/iwsxliff/test3_pt_BZ.iwsxliff", nil)
}
...
func TestRoundTrip_DoubleExtractionIwsXliffAllPendingNotLockedNoTm100(t *testing.T) {
	fileRoundtripEvents(t, "okf_xliff/iwsxliff/test4_fr.iwsxliff", nil)
}
...
func TestExtract_IwsTestExtraction(t *testing.T) {
	parts := readXLIFFFile(t, "okf_xliff/iwsxliff/test1_es.iwsxliff", nil)
...
func TestExtract_IwsNoBlockFinished(t *testing.T) {
	parts := readXLIFFFile(t, "okf_xliff/iwsxliff/test2_es.iwsxliff", nil)
	blocks := bridgetest.TranslatableBlocks(parts)
	require.NotEmpty(t, blocks)
}
...
func TestExtract_SkeletonIwsXliffAllPending(t *testing.T) {
	out := fileRoundtrip(t, "okf_xliff/iwsxliff/test1_es.iwsxliff", nil)
...
func TestExtract_SegmentProperties(t *testing.T) {
	parts := readXLIFFFile(t, "okf_xliff/sdlxliff/adding-segprop.sdlxliff", nil)
	blocks := bridgetest.TranslatableBlocks(parts)
	require.NotEmpty(t, blocks)
}
...
func TestExtract_ManipulateSdlSegmentProperties(t *testing.T) {
	parts := readXLIFFFile(t, "okf_xliff/sdlxliff/manipulate-segprop.sdlxliff", nil)
	blocks := bridgetest.TranslatableBlocks(parts)
	require.NotEmpty(t, blocks)
}
...
func TestExtract_SdlRepetitions(t *testing.T) {
	parts := readXLIFFFile(t, "okf_xliff/sdl-rep/test1.docx.sdlxliff", nil)
	blocks := bridgetest.TranslatableBlocks(parts)
	require.NotEmpty(t, blocks)
}
...
func TestExtract_SdlRepetitionsInPrevOrigin(t *testing.T) {
	parts := readXLIFFFile(t, "okf_xliff/sdl-rep2/reps-in-prev-origin.xlf.sdlxliff", nil)
	blocks := bridgetest.TranslatableBlocks(parts)
	require.NotEmpty(t, blocks)
}
...
func TestExtract_WithPrevOrigin(t *testing.T) {
	parts := readXLIFFFile(t, "okf_xliff/sdlxliff/prev-origin-sdl.sdlxliff", nil)
	blocks := bridgetest.TranslatableBlocks(parts)
	require.NotEmpty(t, blocks)
}
...
func TestExtract_SegmentPropertiesOutputUsingSegLevelData(t *testing.T) {
	out := fileRoundtrip(t, "okf_xliff/sdlxliff/adding-segprop.sdlxliff", nil)
	assert.NotEmpty(t, out)
}
