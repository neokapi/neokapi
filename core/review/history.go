...
// whether the rules moved. Governed says which it is: contextHash is the
// fingerprint the decision in force was recorded under, and an empty one
// reports the version as ungoverned, because nothing vouches for it.
func PriorVersionOf(
	ctx context.Context,
	...
	prior.Governed = v.GovernedBy(contextHash)
	return prior
}
