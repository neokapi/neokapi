...
// @neokapi/format/src/vocabulary.ts.
...
// @neokapi/format/src/vocabulary.ts — the three span types the Go
...
// renderRuns in neokapi-format/src/preview.ts.
...
// in neokapi-format/src/vocabulary.ts.
