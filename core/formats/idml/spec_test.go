...
// native IDML reader. The same spec file feeds the parity bridge
// runner (cli/parity/formats/idml_spec_test.go) so a single source
// of truth describes IDML's behavior across implementations.
