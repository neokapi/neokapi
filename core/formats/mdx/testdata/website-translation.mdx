...
1. Import a termbase (TBX, CSV, JSON) — it's stored at `.kapi/terms.db`
...
- **Import terminology** into the project termbase at `.kapi/terms.db` and add `term-lookup` to your flow
