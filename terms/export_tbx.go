...
func ExportTBX(ctx context.Context, tb Terminology, writer io.Writer, opts TBXExportOptions) error {
	doc := tbxOut{
		Style: "dca",
		Type:  "TBX-Basic",
		Lang:  "en",
		Header: &tbxOutHeader{
			FileDesc: tbxOutFileDesc{
				SourceDesc: tbxOutSourceDesc{P: "Exported by neokapi terms"},
			},
		},
	}
...
// tbxStatusValue maps the terms store status vocabulary onto administrativeStatus
...
// same naming scheme to keep the six terms statuses distinct.
