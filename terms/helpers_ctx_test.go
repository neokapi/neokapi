...
func mustCount(t *testing.T, tb terms.Terminology) int {
	t.Helper()
...
func mustGetConcept(t *testing.T, tb terms.Terminology, id string) (terms.Concept, bool) {
	t.Helper()
...
func mustConcepts(t *testing.T, tb terms.Terminology) []terms.Concept {
	t.Helper()
...
func mustLookup(t *testing.T, tb terms.Terminology, src string, opts terms.LookupOptions) []terms.TermMatch {
	t.Helper()
...
func mustLookupAll(t *testing.T, tb terms.Terminology, src string, opts terms.LookupOptions) []terms.TermMatch {
	t.Helper()
...
func mustSearch(t *testing.T, tb terms.Terminology, query string, src, tgt model.LocaleID, offset, limit int) ([]terms.Concept, int) {
	t.Helper()
...
func mustSearchForStream(t *testing.T, tb terms.Store, query string, src, tgt model.LocaleID, stream string, chain []string, offset, limit int) ([]terms.Concept, int) {
	t.Helper()
