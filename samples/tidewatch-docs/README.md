...
| 6 | Recorded as a harness walkthrough | **PARTIAL**: `harness/demos/s2-tidewatch-build-output/` and `harness/demos/s2-tidewatch-ci/` are authored and capture-verified; nothing has been rendered or published for English, and the Norwegian render is held by [#2032](https://github.com/neokapi/neokapi/issues/2032) |
