...
| 6 | Recorded as a harness walkthrough | **PARTIAL**: `harness/demos/s1-compass-converge/` and `harness/demos/s1-compass-ship-gate/` are authored and capture-verified; nothing has been rendered or published for English, and the Norwegian render is held by [#2032](https://github.com/neokapi/neokapi/issues/2032) |
