...
import { PROMPT_FS, SAFE_X, SAFE_Y } from "./layout.ts";
...
export const PromptCard: React.FC<{ prompt: string }> = ({ prompt }) => {
  ...
  return (
    <AbsoluteFill style={{ background: theme.bgGrad, fontFamily: theme.fontSans, justifyContent: "center", alignItems: "center", padding: `${SAFE_Y}px ${SAFE_X}px` }}>
