...
// findProject wraps kapiproject.FindProject to return a simple error.
func findProject() (*kapiproject.Project, error) {
	return kapiproject.FindProject("")
}

// runProjectFlow executes a flow defined in .kapi/flows/.
func runProjectFlow(cmd *cobra.Command, project *kapiproject.Project, flowName string, args []string) error {
	// Load flow definition
	flowPath := filepath.Join(project.FlowsDirPath(), flowName+".yaml")
