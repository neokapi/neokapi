...
const file_proto_v1_editor_service_proto_rawDesc = "" +
	"\n" +
	"\x1dproto/v1/editor_service.proto\x12\x10gokapi.server.v1\x1a\x1bgoogle/protobuf/empty.proto\"\x17\n" +
	...
	"\fjson_content\x18\x01 \x01(\tR\vjsonContent\"\x95\x01\n" +
	...
	"changeType\x122\n" +
	"\x04user\x18\x02 \x01(\v2\x1e.gokapi.server.v1.PresenceInfoR\x04user2\xfd\x10\n" +
	"\rEditorService\x12Y\n" +
	...
	"\x0fExportTermsJSON\x12(.gokapi.server.v1.ExportTermsJSONRequest\x1a).gokapi.server.v1.ExportTermsJSONResponse\x12Q\n" +
	"\x0eUpdatePresence\x12'.gokapi.server.v1.UpdatePresenceRequest\x1a\x16.google.protobuf.Empty\x12W\n" +
	"\fWatchProject\x12%.gokapi.server.v1.WatchProjectRequest\x1a\x1e.gokapi.server.v1.ProjectEvent0\x01B,Z*github.com/gokapi/gokapi/proto/v1;serverv1b\x06proto3"
...
var file_proto_v1_editor_service_proto_msgTypes = make([]protoimpl.MessageInfo, 57)
var file_proto_v1_editor_service_proto_goTypes = []any{
	...
	(*UpdatePresenceRequest)(nil),      // 47: gokapi.server.v1.UpdatePresenceRequest
	(*PresenceInfo)(nil),               // 48: gokapi.server.v1.PresenceInfo
	(*WatchProjectRequest)(nil),        // 49: gokapi.server.v1.WatchProjectRequest
	(*ProjectEvent)(nil),               // 50: gokapi.server.v1.ProjectEvent
	(*BlockChangeEvent)(nil),           // 51: gokapi.server.v1.BlockChangeEvent
	(*PresenceChangeEvent)(nil),        // 52: gokapi.server.v1.PresenceChangeEvent
	nil,                                // 53: gokapi.server.v1.BlockInfo.TargetsEntry
	nil,                                // 54: gokapi.server.v1.BlockInfo.TargetsCodedEntry
	nil,                                // 55: gokapi.server.v1.BlockInfo.PropertiesEntry
	nil,                                // 56: gokapi.server.v1.ConceptInfo.PropertiesEntry
...
var file_proto_v1_editor_service_proto_depIdxs = []int32{
	...
	53, // 5: gokapi.server.v1.BlockInfo.targets:type_name -> gokapi.server.v1.BlockInfo.TargetsEntry
	54, // 6: gokapi.server.v1.BlockInfo.targets_coded:type_name -> gokapi.server.v1.BlockInfo.TargetsCodedEntry
	55, // 7: gokapi.server.v1.BlockInfo.properties:type_name -> gokapi.server.v1.BlockInfo.PropertiesEntry
	...
	56, // 15: gokapi.server.v1.ConceptInfo.properties:type_name -> gokapi.server.v1.ConceptInfo.PropertiesEntry
	...
	51, // 20: gokapi.server.v1.ProjectEvent.block_change:type_name -> gokapi.server.v1.BlockChangeEvent
	52, // 21: gokapi.server.v1.ProjectEvent.presence_change:type_name -> gokapi.server.v1.PresenceChangeEvent
	48, // 22: gokapi.server.v1.PresenceChangeEvent.user:type_name -> gokapi.server.v1.PresenceInfo
	0,  // 23: gokapi.server.v1.EditorService.GetCurrentUser:input_type -> gokapi.server.v1.GetCurrentUserRequest
	2,  // 24: gokapi.server.v1.EditorService.ListWorkspaces:input_type -> gokapi.server.v1.ListWorkspacesRequest
	5,  // 25: gokapi.server.v1.EditorService.ListEditorProjects:input_type -> gokapi.server.v1.ListEditorProjectsRequest
	9,  // 26: gokapi.server.v1.EditorService.GetEditorProject:input_type -> gokapi.server.v1.GetEditorProjectRequest
	13, // 27: gokapi.server.v1.EditorService.GetBlocks:input_type -> gokapi.server.v1.GetBlocksRequest
	15, // 28: gokapi.server.v1.EditorService.UpdateBlockTarget:input_type -> gokapi.server.v1.UpdateBlockTargetRequest
	16, // 29: gokapi.server.v1.EditorService.ReviewBlock:input_type -> gokapi.server.v1.ReviewBlockRequest
	17, // 30: gokapi.server.v1.EditorService.LookupTMForBlock:input_type -> gokapi.server.v1.TMLookupRequest
	20, // 31: gokapi.server.v1.EditorService.LookupTermsForBlock:input_type -> gokapi.server.v1.TermLookupRequest
	23, // 32: gokapi.server.v1.EditorService.GetTMEntries:input_type -> gokapi.server.v1.TMEntriesRequest
	26, // 33: gokapi.server.v1.EditorService.GetTMCount:input_type -> gokapi.server.v1.TMCountRequest
	28, // 34: gokapi.server.v1.EditorService.AddTMEntry:input_type -> gokapi.server.v1.AddTMEntryRequest
	30, // 35: gokapi.server.v1.EditorService.UpdateTMEntry:input_type -> gokapi.server.v1.UpdateTMEntryRequest
	31, // 36: gokapi.server.v1.EditorService.DeleteTMEntry:input_type -> gokapi.server.v1.DeleteTMEntryRequest
	34, // 37: gokapi.server.v1.EditorService.GetTerms:input_type -> gokapi.server.v1.TermsRequest
	36, // 38: gokapi.server.v1.EditorService.GetTermCount:input_type -> gokapi.server.v1.TermCountRequest
	38, // 39: gokapi.server.v1.EditorService.AddConcept:input_type -> gokapi.server.v1.AddConceptRequest
	40, // 40: gokapi.server.v1.EditorService.UpdateConcept:input_type -> gokapi.server.v1.UpdateConceptRequest
	41, // 41: gokapi.server.v1.EditorService.DeleteConcept:input_type -> gokapi.server.v1.DeleteConceptRequest
	42, // 42: gokapi.server.v1.EditorService.ImportTermsCSV:input_type -> gokapi.server.v1.ImportTermsCSVRequest
	43, // 43: gokapi.server.v1.EditorService.ImportTermsJSON:input_type -> gokapi.server.v1.ImportTermsJSONRequest
	45, // 44: gokapi.server.v1.EditorService.ExportTermsJSON:input_type -> gokapi.server.v1.ExportTermsJSONRequest
	47, // 45: gokapi.server.v1.EditorService.UpdatePresence:input_type -> gokapi.server.v1.UpdatePresenceRequest
	49, // 46: gokapi.server.v1.EditorService.WatchProject:input_type -> gokapi.server.v1.WatchProjectRequest
	1,  // 47: gokapi.server.v1.EditorService.GetCurrentUser:output_type -> gokapi.server.v1.UserResponse
	4,  // 48: gokapi.server.v1.EditorService.ListWorkspaces:output_type -> gokapi.server.v1.ListWorkspacesResponse
	8,  // 49: gokapi.server.v1.EditorService.ListEditorProjects:output_type -> gokapi.server.v1.ListEditorProjectsResponse
	10, // 50: gokapi.server.v1.EditorService.GetEditorProject:output_type -> gokapi.server.v1.EditorProjectResponse
	14, // 51: gokapi.server.v1.EditorService.GetBlocks:output_type -> gokapi.server.v1.GetBlocksResponse
	57, // 52: gokapi.server.v1.EditorService.UpdateBlockTarget:output_type -> google.protobuf.Empty
	57, // 53: gokapi.server.v1.EditorService.ReviewBlock:output_type -> google.protobuf.Empty
	19, // 54: gokapi.server.v1.EditorService.LookupTMForBlock:output_type -> gokapi.server.v1.TMLookupResponse
	22, // 55: gokapi.server.v1.EditorService.LookupTermsForBlock:output_type -> gokapi.server.v1.TermLookupResponse
	25, // 56: gokapi.server.v1.EditorService.GetTMEntries:output_type -> gokapi.server.v1.TMEntriesResponse
	27, // 57: gokapi.server.v1.EditorService.GetTMCount:output_type -> gokapi.server.v1.TMCountResponse
	29, // 58: gokapi.server.v1.EditorService.AddTMEntry:output_type -> gokapi.server.v1.TMEntryResponse
	57, // 59: gokapi.server.v1.EditorService.UpdateTMEntry:output_type -> google.protobuf.Empty
	57, // 60: gokapi.server.v1.EditorService.DeleteTMEntry:output_type -> google.protobuf.Empty
	35, // 61: gokapi.server.v1.EditorService.GetTerms:output_type -> gokapi.server.v1.TermsResponse
	37, // 62: gokapi.server.v1.EditorService.GetTermCount:output_type -> gokapi.server.v1.TermCountResponse
	39, // 63: gokapi.server.v1.EditorService.AddConcept:output_type -> gokapi.server.v1.ConceptResponse
	57, // 64: gokapi.server.v1.EditorService.UpdateConcept:output_type -> google.protobuf.Empty
	57, // 65: gokapi.server.v1.EditorService.DeleteConcept:output_type -> google.protobuf.Empty
	44, // 66: gokapi.server.v1.EditorService.ImportTermsCSV:output_type -> gokapi.server.v1.ImportCountResponse
	44, // 67: gokapi.server.v1.EditorService.ImportTermsJSON:output_type -> gokapi.server.v1.ImportCountResponse
	46, // 68: gokapi.server.v1.EditorService.ExportTermsJSON:output_type -> gokapi.server.v1.ExportTermsJSONResponse
	57, // 69: gokapi.server.v1.EditorService.UpdatePresence:output_type -> google.protobuf.Empty
	50, // 70: gokapi.server.v1.EditorService.WatchProject:output_type -> gokapi.server.v1.ProjectEvent
...
func file_proto_v1_editor_service_proto_init() {
	...
	file_proto_v1_editor_service_proto_msgTypes[50].OneofWrappers = []any{
