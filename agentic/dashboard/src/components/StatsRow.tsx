...
export default function StatsRow() {
  ...
  const stats = [
    { label: 'Events Today', value: String(todayEvents.length), detail: 'audit entries', key: 'events-today' },
    { label: 'Coverage', value: `${coverage}%`, detail: `${translatedBlocks}/${totalBlocks} blocks`, key: 'coverage' },
    { label: 'Translations', value: String(translationEvents.length), detail: 'block updates', key: 'translations' },
...
function StatsGrid({ stats }: { stats: { label: string; value: string; detail: string; key: string }[] }) {
  return (
