...
var evals = []Eval{
	...
	},
	{
		...
		Settings:  "Temperature 0, recorded in the dataset. Max tokens follow the model's ceiling; no seed, because the API exposes none.",
	...
	},
	{
		...
		Settings:  "Temperature 0 on every swept model. Max tokens follow each model's ceiling; no seed, because the APIs expose none.",
	...
	},
	{
		...
		Settings:  "Temperature 0. Concurrency is recorded too, because throughput depends on it. No seed, because the APIs expose none.",
