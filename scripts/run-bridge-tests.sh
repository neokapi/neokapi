...
#
# Environment:
#   GOKAPI_BRIDGE_JAR  — path to the okapi-bridge JAR (required)
#   JAVA_HOME          — optional, used to find java binary
#
# Example:
#   GOKAPI_BRIDGE_JAR=~/.cache/gokapi/bridge/okapi-bridge.jar scripts/run-bridge-tests.sh 4
set -euo pipefail
...
echo "Bridge pool started: $GOKAPI_BRIDGE_ADDRS"
...
GOKAPI_BRIDGE_ADDRS="$GOKAPI_BRIDGE_ADDRS" \
