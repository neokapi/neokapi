...
//
// It must be regenerated whenever the backend's bound method set changes (a new
// App method), i.e. after `wails3 generate bindings`. A stale map makes
// real-main.tsx throw "wbridge: unknown method id <id>" on the first unmapped
// call, which blanks the recorded page — or, worse, surfaces as a plausible-
// looking product error while the app itself is fine.
//
// This mirrors bowrain/apps/bowrain/frontend/scripts/gen-wails-id-map.mjs; keep
// the two in sync.
//
