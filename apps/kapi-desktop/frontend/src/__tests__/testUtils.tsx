 ...
 *
 * Desktop pages read server state through react-query, so every rendered tree
 * needs a client. Importing `render` from here (instead of directly from
 * `@testing-library/react`) provides one automatically, with retries off and a
 * throwaway cache per render for isolation.
 */
