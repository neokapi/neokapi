...
describe("MemoryBrowser", () => {
  ...
  describe("rendering entries", () => {
    ...
    it("displays singular entry count", async () => {
      ...
      render(
        <MemoryBrowser adapter={singleAdapter} sourceLocale="en-US" targetLocales={["fr-FR"]} />,
      );
  ...
  describe("empty state", () => {
    ...
    it("shows search empty state with clear button", async () => {
      ...
      render(
        <MemoryBrowser adapter={emptyAdapter} sourceLocale="en-US" targetLocales={["fr-FR"]} />,
      );
  ...
  describe("facet sidebar", () => {
    it("shows facet sidebar when adapter has getFacets", async () => {
      ...
      render(
        <MemoryBrowser adapter={facetAdapter} sourceLocale="en-US" targetLocales={["fr-FR"]} />,
      );
  ...
  describe("add entry", () => {
    it("opens add form and calls adapter.addEntry with variants map", async () => {
      ...
      expect(screen.getByText("Add memory entry")).toBeInTheDocument();
