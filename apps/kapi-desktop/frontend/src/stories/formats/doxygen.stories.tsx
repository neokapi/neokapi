...
export const NativeConfig: Story = {
  ...
  render: () => <ConfigEditor schemaName="doxygen" source="builtIn" />,
};
export const OkapiConfig: Story = {
  name: "Okapi Configuration",
  render: () => <ConfigEditor schemaName="okf_doxygen" source="bridge" />,
};
export const Compare: Story = {
  name: "Side by Side",
  render: () => <CompareEditor nativeName="doxygen" okapiName="okf_doxygen" />,
};
