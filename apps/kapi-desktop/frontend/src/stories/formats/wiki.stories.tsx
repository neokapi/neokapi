...
const meta: Meta = {
  title: "Formats & Tools/Formats/Wiki Format",
...
export const NativeConfig: Story = {
  ...
  render: () => <ConfigEditor schemaName="wiki" source="builtIn" />,
};
export const OkapiConfig: Story = {
  name: "Okapi Configuration",
  render: () => <ConfigEditor schemaName="okf_wiki" source="bridge" />,
};
export const Compare: Story = {
  name: "Side by Side",
  render: () => <CompareEditor nativeName="wiki" okapiName="okf_wiki" />,
};
