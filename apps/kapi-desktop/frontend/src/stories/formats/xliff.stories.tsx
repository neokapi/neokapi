...
export const NativeConfig: Story = {
  ...
  render: () => <ConfigEditor schemaName="xliff" source="builtIn" />,
};
export const OkapiConfig: Story = {
  name: "Okapi Configuration",
  render: () => <ConfigEditor schemaName="okf_xliff" source="bridge" />,
};
export const Compare: Story = {
  name: "Side by Side",
  render: () => <CompareEditor nativeName="xliff" okapiName="okf_xliff" />,
};
