...
const meta: Meta = {
  title: "Formats & Tools/Formats/HTML Format",
...
export const NativeConfig: Story = {
  ...
  render: () => <ConfigEditor schemaName="html" source="builtIn" />,
};
export const OkapiConfig: Story = {
  name: "Okapi Configuration",
  render: () => <ConfigEditor schemaName="okf_html" source="bridge" />,
};
export const Compare: Story = {
  name: "Side by Side",
  render: () => <CompareEditor nativeName="html" okapiName="okf_html" />,
};
