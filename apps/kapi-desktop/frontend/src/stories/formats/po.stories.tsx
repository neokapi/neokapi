...
export const NativeConfig: Story = {
  ...
  render: () => <ConfigEditor schemaName="po" source="builtIn" />,
};
export const OkapiConfig: Story = {
  name: "Okapi Configuration",
  render: () => <ConfigEditor schemaName="okf_po" source="bridge" />,
};
export const Compare: Story = {
  name: "Side by Side",
  render: () => <CompareEditor nativeName="po" okapiName="okf_po" />,
};
