      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24 }}>
        <div>
          ...
          <div className="rounded-lg border p-4">
            {np > 0 ? (
              <SchemaForm schema={ns} values={nv} onChange={setNv} />
            ) : (
        ...
        <div>
          ...
          <div className="rounded-lg border p-4">
            {op > 0 ? (
              <SchemaForm schema={os} values={ov} onChange={setOv} />
            ) : (
              <p className="text-sm text-muted-foreground">No parameters.</p>
            )}
          </div>
...
const meta: Meta = {
  title: "Formats & Tools/Formats/Plain Text/Plain Text Format",
...
export const NativeConfig: Story = {
  ...
  render: () => <ConfigEditor schemaName="plaintext" source="builtIn" />,
};
export const OkapiConfig: Story = {
  name: "Okapi Configuration",
  render: () => <ConfigEditor schemaName="okf_plaintext" source="bridge" />,
};
export const Compare: Story = {
  name: "Side by Side",
  render: () => <CompareEditor nativeName="plaintext" okapiName="okf_plaintext" />,
};
