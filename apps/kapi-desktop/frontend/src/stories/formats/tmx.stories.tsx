...
export const NativeConfig: Story = {
  ...
  render: () => <ConfigEditor schemaName="tmx" source="builtIn" />,
};
export const OkapiConfig: Story = {
  name: "Okapi Configuration",
  render: () => <ConfigEditor schemaName="okf_tmx" source="bridge" />,
};
export const Compare: Story = {
  name: "Side by Side",
  render: () => <CompareEditor nativeName="tmx" okapiName="okf_tmx" />,
};
