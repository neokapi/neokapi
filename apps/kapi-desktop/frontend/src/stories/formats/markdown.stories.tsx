...
export const NativeConfig: Story = {
  ...
  render: () => <ConfigEditor schemaName="markdown" source="builtIn" />,
};
export const OkapiConfig: Story = {
  name: "Okapi Configuration",
  render: () => <ConfigEditor schemaName="okf_markdown" source="bridge" />,
};
export const Compare: Story = {
  name: "Side by Side",
  render: () => <CompareEditor nativeName="markdown" okapiName="okf_markdown" />,
};
