...
const meta: Meta = {
  title: "Formats & Tools/Formats/Data/XML Format",
...
export const NativeConfig: Story = {
  ...
  render: () => <ConfigEditor schemaName="xml" source="builtIn" />,
};
export const OkapiConfig: Story = {
  name: "Okapi Configuration",
  render: () => <ConfigEditor schemaName="okf_xml" source="bridge" />,
};
export const Compare: Story = {
  name: "Side by Side",
  render: () => <CompareEditor nativeName="xml" okapiName="okf_xml" />,
};
