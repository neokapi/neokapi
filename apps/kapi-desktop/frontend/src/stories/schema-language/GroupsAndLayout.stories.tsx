...
export const GroupDescription: Story = {
  ...
  args: {
    description:
      "Groups can have a `description` field that appears as help text below the group header.",
    schema: {
      ...
      "ui:groups": [
        {
          ...
          description:
            "Control which content is extracted for translation. Rules are evaluated in order — the first matching rule wins.",
        ...
        },
        {
          ...
          description:
            "Patterns that identify inline codes (placeholders, variables) within translatable text. Matched content is protected from translation.",
...
export const UngroupedFields: Story = {
  ...
  args: {
    ...
    schema: {
      ...
      type: "object",
      "ui:groups": [{ id: "main", label: "Main Settings", fields: ["extractAll"] }],
      properties: {
        extractAll: { type: "boolean", title: "Extract All", default: true },
        encoding: {
          type: "string",
