...
const sidebars: SidebarsConfig = {
  // NOTE: this is the NEUTRAL base structure shared by both surface-model PRs.
  // PR-A reorganizes the recipe section into separate "Kapi CLI" and
  // "Kapi Desktop" pillars; PR-B keeps one recipe set + thin overview pages and
  // deploys the <Cli>/<Desktop> toggle. Get Started, Desktop, and the recipe
  // de-duplication are identical in both.
  kapiSidebar: [
    {
      type: "category",
      label: "Get started",
    ...
    // reads as co-equal with the CLI.
    {
      type: "category",
      label: "Kapi Desktop",
      collapsible: false,
    ...
    // One source-first journey: prepare your source, then go multilingual.
    {
      type: "category",
