...
const sidebars: SidebarsConfig = {
  // PR-A — "Separate sections" surface model. Three Kapi pillars: an agnostic
  // Get Started, a Kapi CLI section (overview + CLI-shaped recipes), and a Kapi
  // Desktop section (overview + slim tour + Desktop-native recipes). Recipes are
  // single-surface — CLI recipes are pure CLI; GUI tasks live in Desktop recipes.
  kapiSidebar: [
    {
      type: "category",
      label: "Get started",
    ...
    },
    {
      ...
      items: [
        ...
        {
          type: "category",
          label: "Desktop recipes",
          collapsed: false,
          items: [
            "kapi/desktop/recipes/build-a-flow-visually",
            "kapi/desktop/recipes/author-a-project-visually",
            "kapi/desktop/recipes/manage-plugins",
            "kapi/desktop/recipes/store-ai-credentials",
          ],
        },
      ],
    },
