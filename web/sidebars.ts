...
const sidebars: SidebarsConfig = {
  ...
  kapiSidebar: [
    ...
    },
    {
      ...
      className: "sidebar-section-heading",
      items: [
        { type: "doc", id: "kapi/recipes/index", label: "All guides", key: "kapi-recipes-overview" },
        ...
        { type: "doc", id: "kapi/recipes/brand-guide-in-10-minutes", label: "Brand guide in 10 minutes" },
        { type: "doc", id: "kapi/recipes/content-governance-for-ai", label: "Content governance for AI" },
        { type: "doc", id: "kapi/recipes/bulk-rewrite-with-an-agent", label: "Bulk rewrite with an agent" },
