---
sidebar_position: 1
title: Oversikt over Kapi Desktop
description: Kapi Desktop er den visuelle følgesvennen til kapi CLI — en app for å bygge lokaliseringsflyter, kjøre verktøy, håndtere tillegg og lagre AI-legitimasjon uten å skrive YAML eller huske flagg.
