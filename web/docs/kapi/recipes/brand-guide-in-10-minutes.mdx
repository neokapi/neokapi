...
3. **See it work.** The **Checks** view now carries brand findings over everything the project tracks, and the brand gate joins each locale's [ship-gate cell](/kapi/recipes/gate-localization-in-ci).
