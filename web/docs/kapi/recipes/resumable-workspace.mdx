...
For the working models this sits on — ad-hoc vs. project, the `.klz` parcel, and the bindings each step uses — see [Projects](/kapi/projects); this recipe walks the pause-and-resume task.
