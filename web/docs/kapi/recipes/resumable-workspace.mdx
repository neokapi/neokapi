...
The lab below is the same workflow, interactive — pick a sample (including binary
**Word/Excel** documents) and step through it, watching the workspace's recipe,
per-locale overlays, and **dirty → clean** state update after each step.
