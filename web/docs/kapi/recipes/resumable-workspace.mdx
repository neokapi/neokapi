...
[`.kapi` project](/kapi/modes). This recipe is the serverless convenience where
there is no project — you open a `.klz` into a working cache, run tools against
it, and pack it back. The bindings are the same ones any flow uses:
