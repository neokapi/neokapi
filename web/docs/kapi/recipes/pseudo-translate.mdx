...
- [Reuse what you've translated](/kapi/recipes/pre-translate-with-tm) — pseudo-translation as the visible-gap step.
- [Quality checks](/framework/checks/qa-checks) — the broader check families.
