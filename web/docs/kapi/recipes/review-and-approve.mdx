...
To put the record in git as well, write it out with `kapi context snapshot` and commit the shards it produces. That is a team's choice about what a pull request should show; see [Moving context](/kapi/context-portability).
