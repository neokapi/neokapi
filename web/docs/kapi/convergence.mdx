...
approval is an authored **decision** (who signed off on which exact
...
[`kapi context export`](/kapi/context-portability), and a team that wants it
reviewable in git writes it there with `kapi context snapshot`. A
