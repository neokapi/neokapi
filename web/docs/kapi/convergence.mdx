...
translation of it: the wording a reviewer approved is kept in the content memory
under the sentence it *does* translate, where a later fuzzy match can still
recycle it, and the entry itself is drafted afresh.
