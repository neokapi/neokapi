...
6. **Install plugins (optional).** In **Plugins**, browse the registry and
   install what your content needs — the **kapi-sat** segmenter, the
   **kapi-pdfium** PDF reader, the **kapi-vision** OCR engine, or the
   **kapi-asr** transcriber; the formats and tools a plugin adds appear
   automatically.
