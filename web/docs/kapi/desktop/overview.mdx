...
- **Project dashboard** — Open to your projects and pick up where you left off. Each project home shows its languages, content collections, and each locale's standing against its ship gate, with **Bring up to date** a click away.
- **Review surface** — Work the queue of translations awaiting a person: inspect source and target with findings, edit, then approve, reject, or sign off — keyboard-first. See [Review & approve](/kapi/recipes/review-and-approve).
