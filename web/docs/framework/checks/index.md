...
When a recipe declares the comments of a file a reader parses, such as YAML with
`comments: true`, each comment is a block beside the reader's blocks, and a
changed line takes whichever block it sits in.
