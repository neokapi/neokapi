  ...
  return (
    ...
    >
      <main className="container margin-vert--lg">
        ...
        <p>
          Interactive documentation for all {data.formats.length} built-in formats.{" "}
          {configurable.length} formats have configurable parameters ({totalParams} total). Edit
          parameter values below to generate configuration output.
        </p>
