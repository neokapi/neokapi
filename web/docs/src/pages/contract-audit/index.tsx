    ...
    >
      <main className="container margin-vert--lg">
        ...
        <p>
          ...
          Okapi version). The native column shows whether neokapi has a Go
          counterpart for that test (joined via <code>// okapi:</code>{" "}
          annotations) and whether it passes. The bridge column reflects the
          per-filter outcomes from <code>.parity/test-comparison.json</code>:
          a <em>read</em> badge for head-to-head reader parity and a{" "}
          <em>round-trip</em> badge (when the format has a writer wired up)
          for input → reader → writer byte-equality between the two sides.
          Generated by <code>scripts/contract-audit/</code> from Surefire XML +{" "}
          <code>go test -json</code> + the parity report. See{" "}
          <a href="/test-comparison">/test-comparison</a> for the legacy
