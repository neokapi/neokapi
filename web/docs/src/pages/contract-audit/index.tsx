  ...
  return (
    ...
    >
      <main className="container margin-vert--lg">
        ...
        <p>
          Each row is one Okapi <code>@Test</code> method (pinned to a specific
          Okapi version). The native and bridge columns show whether neokapi
          has a Go counterpart for that test, and whether it passes. Generated
          by <code>scripts/contract-audit/</code> from Surefire XML +{" "}
          <code>go test -json</code> output. See <a href="/test-comparison">/test-comparison</a> for the legacy
          (frozen) per-test-class snapshot.
        </p>
