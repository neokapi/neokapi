...
sidebar_position: 4
title: kcat
description: kcat prints the text of files block by block, regardless of format, so a Word document, a JSON catalog and an XLIFF file all print as plain prose.
