...
| `termbase`         | string              | Path to a terms store, resolved relative to the project root; used for project-scoped term enforcement with no `--terms` flag |
