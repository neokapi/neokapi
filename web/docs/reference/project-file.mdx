...
- [kapi.yaml Project File Format](/contribute/implementation/kapi-project-file) — the implementation note: the `KapiProject`, `Defaults`, `Collection` and `Profile` struct layouts, the named-collection content shape, validation rules, and how platform extensions decode unknown keys.
