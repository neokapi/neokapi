...
| `brand_voice`      | VoiceBinding   | Bind a voice profile as standing project context (see [brand_voice](#brand_voice))                                |
...
Bind a voice profile under `defaults.voice`. Exactly one source is expected.
