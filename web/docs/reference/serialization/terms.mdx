...
store](/kapi/project-store) are the index the bundle compiles into, kept outside
git, never the other way round.
...
- **The compiled SQLite tables.** The terms tables in the project store are
