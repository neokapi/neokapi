---
id: regex
title: 'Regex Extraction format'
description: 'Extract translatable strings from arbitrary text formats using configurable regular-expression rules.'
sidebar_label: 'Regex Extraction'
slug: /reference/formats/regex
