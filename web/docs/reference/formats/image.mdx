...
id: image
title: 'Image format'
description: 'Translate raster images by emitting the picture as a translatable Media asset, recognizing embedded text with OCR, and translating alt-text/caption sidecars.'
sidebar_label: 'Image'
