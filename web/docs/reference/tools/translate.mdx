...
description: 'Translate block content with an LLM or machine-translation provider.'
sidebar_label: 'Translate'
slug: /reference/tools/translate
...
<ToolReferencePage id={"translate"} source={"built-in"} />
