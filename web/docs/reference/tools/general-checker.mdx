---
id: general-checker
title: 'General Quality Check tool'
description: 'Compare source and target for general quality. Expects: filter events. Sends back: filter events.'
sidebar_label: 'General Quality Check'
slug: /reference/tools/general-checker
...
# General Quality Check tool

<ToolReferencePage id={"general-checker"} source={"okapi"} />
