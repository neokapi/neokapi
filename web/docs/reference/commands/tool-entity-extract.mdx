---
id: tool-entity-extract
title: 'kapi tool entity-extract'
description: 'Detect named entities (people, organizations, products, locations) with an LLM, a local NER model, or both'
sidebar_label: 'tool entity-extract'
slug: /reference/commands/tool-entity-extract
...
# kapi tool entity-extract

<CommandReferencePage id={"tool.entity-extract"} />
