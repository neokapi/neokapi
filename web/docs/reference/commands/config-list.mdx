---
id: config-list
title: 'kapi config list'
description: 'List every configured value, including plugin namespaces'
sidebar_label: 'config list'
slug: /reference/commands/config-list
...
<CommandReferencePage id={"config.list"} />
