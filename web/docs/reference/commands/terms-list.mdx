---
id: terms-list
title: 'kapi terms list'
description: 'List named terms stores in KAPI_HOME'
sidebar_label: 'terms list'
slug: /reference/commands/terms-list
...
<CommandReferencePage id={"terms.list"} />
