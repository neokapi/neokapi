---
id: voice-guide
title: 'kapi voice guide'
description: 'Print the voice guide (inject into your assistant''s context)'
sidebar_label: 'voice guide'
slug: /reference/commands/voice-guide
...
<CommandReferencePage id={"voice.guide"} />
