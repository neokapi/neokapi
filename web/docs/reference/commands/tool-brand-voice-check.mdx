---
id: tool-brand-voice-check
title: 'kapi tool brand-voice-check'
description: 'Check text against a brand voice profile using an LLM provider'
sidebar_label: 'tool brand-voice-check'
slug: /reference/commands/tool-brand-voice-check
...
# kapi tool brand-voice-check

<CommandReferencePage id={"tool.brand-voice-check"} />
