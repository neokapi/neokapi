---
id: tool-media-refine
title: 'kapi tool media-refine'
description: 'Re-read low-confidence OCR/ASR lines with a configurable multimodal LLM'
sidebar_label: 'tool media-refine'
slug: /reference/commands/tool-media-refine
...
# kapi tool media-refine

<CommandReferencePage id={"tool.media-refine"} />
