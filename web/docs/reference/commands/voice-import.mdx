---
id: voice-import
title: 'kapi voice import'
description: 'Import a profile YAML into the local voice store'
sidebar_label: 'voice import'
slug: /reference/commands/voice-import
...
<CommandReferencePage id={"voice.import"} />
