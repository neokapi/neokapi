---
id: context-log
title: 'kapi context log'
description: 'Show how this project''s context came to be'
sidebar_label: 'context log'
slug: /reference/commands/context-log
...
<CommandReferencePage id={"context.log"} />
