---
id: tool-term-extract
title: 'kapi tool term-extract'
description: 'Extract candidate terminology from content using an LLM provider'
sidebar_label: 'tool term-extract'
slug: /reference/commands/tool-term-extract
...
# kapi tool term-extract

<CommandReferencePage id={"tool.term-extract"} />
