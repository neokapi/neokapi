---
id: skills-install
title: 'kapi skills install'
description: 'Install skills into .claude/skills (project or user scope)'
sidebar_label: 'skills install'
slug: /reference/commands/skills-install
...
<CommandReferencePage id={"skills.install"} />
