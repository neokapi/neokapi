---
id: terms-search
title: 'kapi terms search'
description: 'Search concepts in the terms store'
sidebar_label: 'terms search'
slug: /reference/commands/terms-search
...
<CommandReferencePage id={"terms.search"} />
