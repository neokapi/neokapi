---
id: exec-term-extract
title: 'kapi exec term-extract'
description: 'Extract candidate terminology from content using an LLM provider'
sidebar_label: 'exec term-extract'
slug: /reference/commands/exec-term-extract
...
# kapi exec term-extract

<CommandReferencePage id={"exec.term-extract"} />
