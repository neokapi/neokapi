---
id: tm-export
title: 'kapi tm export'
description: 'Export translation memory to TMX, .kmb, or .kmz'
sidebar_label: 'tm export'
slug: /reference/commands/tm-export
...
<CommandReferencePage id={"tm.export"} />
