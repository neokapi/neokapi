---
id: telemetry-off
title: 'kapi telemetry off'
description: 'Disable anonymous usage telemetry (persists to the global config file)'
sidebar_label: 'telemetry off'
slug: /reference/commands/telemetry-off
...
<CommandReferencePage id={"telemetry.off"} />
