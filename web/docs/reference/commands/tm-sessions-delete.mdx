---
id: tm-sessions-delete
title: 'kapi tm sessions delete'
description: 'Remove a session record (entries are retained, session_id cleared)'
sidebar_label: 'tm sessions delete'
slug: /reference/commands/tm-sessions-delete
...
# kapi tm sessions delete

<CommandReferencePage id={"tm.sessions.delete"} />
