---
id: context-confirm
title: 'kapi context confirm'
description: 'Make a proposed rule binding'
sidebar_label: 'context confirm'
slug: /reference/commands/context-confirm
...
<CommandReferencePage id={"context.confirm"} />
