---
id: context-keep
title: 'kapi context keep'
description: 'Establish suggestions as rules'
sidebar_label: 'context keep'
slug: /reference/commands/context-keep
...
<CommandReferencePage id={"context.keep"} />
