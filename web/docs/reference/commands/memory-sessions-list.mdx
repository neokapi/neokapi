...
title: 'kapi memory sessions list'
description: 'List all import sessions'
sidebar_label: 'memory sessions list'
slug: /reference/commands/memory-sessions-list
...
# kapi memory sessions list

<CommandReferencePage id={"memory.sessions.list"} />
