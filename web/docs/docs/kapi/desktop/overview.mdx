...
Flows are pipelines of steps. Kapi ships built-in ones — AI translation, quality checks, pseudo-translation, translation-memory leverage, redact-and-restore — and you can copy any of them to edit, or build your own.
