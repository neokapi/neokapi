...
The lab below runs the **real kapi engine in your browser** (WebAssembly) — pick a
sample (including binary Word/Excel documents), step through
`extract → pseudo-translate → pack → merge`, and watch the workspace's recipe,
