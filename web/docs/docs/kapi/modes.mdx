...
<LanesDiagram
  caption="Increasing statefulness, left to right. A .klz parcel moves work between any of them."
  lanes={[
...
| `store` | the project's `.kapi/cache` (blocks + overlays) | commit overlays — **no file** |
