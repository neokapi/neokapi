...
This note provides implementation details for [AD-009](/architecture/009-translation-memory).
...
The `tm-leverage` tool ([AD-006](/architecture/006-tool-system)) applies adaptations automatically -- translators receive pre-adapted targets with correct entity values.
