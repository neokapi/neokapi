...
- [Terminology QA](/guides/use-case-terminology-qa) — validating terminology compliance in translated files
...
- [Terminology Management](/framework/terminology) — how the terminology system works
