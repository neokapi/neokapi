...
| [Tool & Data-Type Model Redesign](tool-data-model-redesign.md) | [AD-006](/contribute/architecture/006-tool-system) · [AD-002](/contribute/architecture/002-content-model) | Design proposal (RFC): facets, consumes/produces, segment iteration, typed source/sink |
