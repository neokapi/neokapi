...
[Brand Voice](/framework/brand-voice) for the profile schema and scoring model.
...
See [Try It in Your Browser](/get-started/try-it) for more runnable
...
[Using Kapi with AI Assistants](/cli/mcp).
...
content-aware translation memory ([Sievepen](/framework/translation-memory)) with
TMX import/export, and concept-oriented [terminology](/framework/terminology) with
...
- [Installation](/get-started/installation) — install kapi CLI
- [Quick Start](/get-started/quickstart) — keep AI output on-brand, then localize it
