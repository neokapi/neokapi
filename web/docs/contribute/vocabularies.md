...
description: How to implement and extend neokapi vocabularies, covering the JSON type-definition format, category:name identifiers, rendering and display metadata, and registering a vocabulary with the framework.
