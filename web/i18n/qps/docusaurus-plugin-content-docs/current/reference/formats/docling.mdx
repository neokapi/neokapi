...
description: 'Read DoclingDocument JSON — Docling''s native, lossless serialization — into the content model with semantic roles and page geometry.'
...
# ▒ ĐöçļîñĝĐöçüḿéñţ ĴŠÖÑ ƒöŕḿàţ (.ĵšöñ) ▒
