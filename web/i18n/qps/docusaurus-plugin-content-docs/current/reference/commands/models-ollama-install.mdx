---
id: models-ollama-install
title: 'kapi models ollama install'
description: 'Print how to install the Ollama runtime (or install it on macOS with --run)'
sidebar_label: 'models ollama install'
slug: /reference/commands/models-ollama-install
...
# ▒ ķàþî ḿöđéļš öļļàḿà îñšţàļļ ▒

<CommandReferencePage id={"models.ollama.install"} />
