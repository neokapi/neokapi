...
<PipelineDiagram
  channelLabel=""
  stages={[
    { label: "kapi extract", sub: "TM-forhåndsfyll", role: "io" },
    { label: "tospråklig fil", sub: "XLIFF / PO / .klz", role: "io" },
    { label: "oversett andre steder", role: "translate" },
    { label: "kapi merge", sub: "+ TM-absorber", role: "io" },
    { label: "lokaliserte filer", role: "io" },
  ]}
/>
...
<PipelineDiagram
  channelLabel=""
  stages={[
    { label: "kapi run -i file", sub: "ingen -o", role: "translate" },
    { label: "prosjektlager", sub: "standardsluk · targets/<locale>-overlegg", role: "io" },
