...
// The Gemma Lab: run `kapi ai-translate --provider gemma` entirely in your
      ...
      <main className={styles.page}>
        <div className={styles.hero}>
          ...
          <p className={styles.lede}>
            Translate text with <strong>Gemma&nbsp;4</strong> running right here in your browser. The{" "}
            <Link to="/lab">Lab</Link>'s WASM engine runs <code>kapi ai-translate --provider gemma</code>,
            and the model itself executes via <strong>transformers.js</strong> on{" "}
            <strong>WebGPU</strong> — the same ONNX model the native <code>kapi-llm</code> plugin runs
            in-process. It is a free, private alternative to the paid cloud providers: the model is a
            one-time multi-GB download (then cached by your browser), and nothing leaves the page. A{" "}
            <strong>WebGPU-capable browser</strong> is required.
          </p>
