...
export default function Tools() {
  ...
  return (
    <Layout
      ...
      description="Interactive reference for every neokapi processing tool, grouped by category with live, configurable parameters."
    >
      <main className="container margin-vert--lg">
        ...
        <p>
          ...
          step. Each tool has a shareable link. Tools maintained in neokapi itself are tagged{" "}
          <strong>Built-in</strong> (<ReferenceCount kind="tool" source="built-in" />
          ); installed plugins can add their own, tagged <strong>Plugin</strong>.
        </p>
