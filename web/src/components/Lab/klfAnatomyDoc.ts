// The worked example behind the KLF anatomy page (/klf-lab): one realistic
// extracted source file, serialized field-by-field so every line of the
// resulting `.klf` text is tagged with the anatomical part it belongs to
...
// field order of the spec (/reference/klf/spec): envelope fields in struct
...
export const TERMS: AnatomyTerm[] = [
  {
    id: "envelope",
    title: "File envelope",
    spec: "/reference/klf/spec#file-envelope",
    body: [
      "The top-level object of a .klf file. kind is the magic string readers sniff to detect the format; schemaVersion carries the MAJOR.MINOR wire contract — a consumer must reject an unrecognized major version and should accept unknown minors, ignoring fields it does not recognize.",
  ...
  },
  {
    id: "generator",
    title: "GeneratorInfo",
    spec: "/reference/klf/spec#generatorinfo",
    body: [
  ...
  },
  {
    id: "project",
    title: "ProjectInfo",
    spec: "/reference/klf/spec#projectinfo",
    body: [
  ...
  },
  {
    id: "vocabulary",
    title: "Vocabulary",
    spec: "/reference/klf/spec#vocabulary",
    body: [
  ...
  },
  {
    id: "document",
    title: "Document",
    spec: "/reference/klf/spec#document",
    body: [
      "One extracted source file: its path, its documentType, and the blocks extracted from it. A .klf file wraps one or more documents. A document may also carry a sourceHash and a skeleton — the opaque payload a merge step consumes to reconstruct the original file with translated content spliced back in (omitted in this example).",
    ],
  },
  {
    id: "block",
    title: "Block",
    spec: "/reference/klf/spec#block",
    body: [
  ...
  },
  {
    id: "source",
    title: "Source runs",
    spec: "/reference/klf/spec#the-run-model",
    body: [
  ...
  },
  {
    id: "run-text",
    title: "Run — text",
    spec: "/reference/klf/spec#text--a-plain-text-chunk",
    body: [
  ...
  },
  {
    ...
    spec: "/reference/klf/spec#pcopen--pcclose--paired-codes",
    body: [
  ...
  },
  {
    id: "run-ph",
    title: "Run — ph",
    spec: "/reference/klf/spec#ph--a-self-closing-placeholder",
    body: [
  ...
  },
  {
    id: "run-plural",
    title: "Run — plural",
    spec: "/reference/klf/spec#plural--a-structured-plural-construct",
    body: [
  ...
  },
  {
    id: "targets",
    title: "Targets",
    spec: "/reference/klf/spec#targets",
    body: [
  ...
  },
  {
    id: "placeholders",
    title: "Placeholders",
    spec: "/reference/klf/spec#placeholder",
    body: [
  ...
  },
  {
    ...
    spec: "/reference/klf/spec#blockproperties",
    body: [
...
/** The example as plain `.klf` text (used for tokenization and copy). */
