    ...
    <nav className="fixed top-0 left-0 right-0 z-50 border-b border-brand-500/8 bg-surface-950/85 backdrop-blur-xl">
      <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-6">
        ...
        <div className="hidden items-center gap-8 md:flex">
          <a
            href="#brand-loop"
            className="text-sm text-neutral-400 transition hover:text-brand-400"
          >
            How it works
          </a>
          <a href="#features" className="text-sm text-neutral-400 transition hover:text-brand-400">
            Features
          </a>
          <a href="#cli" className="text-sm text-neutral-400 transition hover:text-brand-400">
            CLI
          </a>
          <a href="#formats" className="text-sm text-neutral-400 transition hover:text-brand-400">
            Formats
          </a>
          <a
            href="#get-started"
      ...
      {open && (
        <div className="border-t border-surface-700 bg-surface-950/95 px-6 py-4 md:hidden">
          <div className="flex flex-col gap-3">
            ...
            <a href="#features" onClick={() => setOpen(false)} className="text-sm text-neutral-400">
              Features
            </a>
            <a href="#cli" onClick={() => setOpen(false)} className="text-sm text-neutral-400">
              CLI
            </a>
            <a href="#formats" onClick={() => setOpen(false)} className="text-sm text-neutral-400">
              Formats
            </a>
            <a
              href="#get-started"
