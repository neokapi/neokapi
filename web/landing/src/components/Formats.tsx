      ...
      <div className="mx-auto max-w-6xl">
        <div className="mb-12 text-center">
          <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-brand-500/15 bg-brand-500/[0.06] px-3.5 py-1.5 text-xs font-medium text-brand-300">
            Still the localization Swiss-army-knife
          </div>
          <h2 className="font-display text-3xl font-bold tracking-tight text-white sm:text-4xl">
            The formats your content lives in
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-lg text-neutral-400">
            30+ native readers and writers for localization, data, content, and
            office formats, detected by extension, MIME type, or content — plus
            57+ Java filters through the Okapi bridge. Round-trip, in place, not
