          ...
          <div className="mx-auto min-w-[800px] max-w-[960px]">
            <svg viewBox="0 0 960 340" className="w-full" xmlns="http://www.w3.org/2000/svg">
              ...
              {INPUT_FILES.map((file, i) => {
                ...
                return (
                  <g key={file}>
                    <rect x="10" y={y} width="90" height="32" rx="6" fill="#0f1f1b" stroke="#1e3a32" strokeWidth="1" />
                    <text x="55" y={y + 20} textAnchor="middle" fill="#7aebd4" fontSize="10" fontFamily="Source Code Pro, monospace">{file}</text>
                  </g>
                )
              })}
              ...
              {INPUT_FILES.map((_, i) => {
                ...
                return (
                  <g key={`in-line-${i}`}>
                    <line x1="100" y1={y} x2="140" y2={170} stroke="#25c2a0" strokeWidth="1" opacity="0.25" />
                    <circle r="2.5" fill="#25c2a0" opacity="0">
                      <animateMotion dur="2s" begin={`${i * 0.4}s`} repeatCount="indefinite"
                        path={`M100,${y} L140,170`} />
                      <animate attributeName="opacity" values="0;0.8;0.8;0" keyTimes="0;0.15;0.8;1" dur="2s" begin={`${i * 0.4}s`} repeatCount="indefinite" />
                    </circle>
                  </g>
                )
              })}
              ...
              {/* ─── Reader Stage ─── */}
              <rect x="140" y="140" width="100" height="60" rx="10" fill="#0f1f1b" stroke="#25c2a0" strokeWidth="1.5" opacity="0.9" />
              <text x="190" y="166" textAnchor="middle" fill="#fff" fontSize="13" fontFamily="Outfit, sans-serif" fontWeight="600">Reader</text>
              <text x="190" y="184" textAnchor="middle" fill="#4fddbf" fontSize="9" fontFamily="Source Code Pro, monospace">DataFormat</text>
              ...
              <circle r="3" fill="#25c2a0" filter="url(#glow-teal)" opacity="0">
                <animateMotion dur="1.5s" begin="0.75s" repeatCount="indefinite" path="M240,170 L290,170" />
                <animate attributeName="opacity" values="0;1;1;0" keyTimes="0;0.1;0.8;1" dur="1.5s" begin="0.75s" repeatCount="indefinite" />
              </circle>

              {/* ─── Terminology Stage ─── */}
              <rect x="290" y="140" width="100" height="60" rx="10" fill="#0f1f1b" stroke="#f59e0b" strokeWidth="1.5" opacity="0.9" />
              <text x="340" y="166" textAnchor="middle" fill="#fff" fontSize="13" fontFamily="Outfit, sans-serif" fontWeight="600">Terminology</text>
              <text x="340" y="184" textAnchor="middle" fill="#f59e0b" fontSize="9" fontFamily="Source Code Pro, monospace">Tool</text>
              ...
              {WORKERS.map((_, i) => {
                ...
                return (
                  <g key={`fan-${i}`}>
                    <line x1="430" y1="170" x2="460" y2={wy + 16} stroke="#06b6d4" strokeWidth="1" opacity="0.3" />
                    <line x1="580" y1={wy + 16} x2="610" y2="170" stroke="#06b6d4" strokeWidth="1" opacity="0.3" />
                    ...
                    <circle r="2.5" fill="#06b6d4" filter="url(#glow-cyan)" opacity="0">
                      ...
                      <animate attributeName="opacity" values="0;0.9;0.9;0" keyTimes="0;0.08;0.88;1" dur="2.4s" begin={`${i * 0.5}s`} repeatCount="indefinite" />
                    </circle>
                  </g>
                )
              })}
              ...
              {WORKERS.map((label, i) => {
                ...
                return (
                  <g key={label}>
                    <rect x="460" y={wy} width="120" height="32" rx="8"
                    ...
                    {/* Activity pulse */}
                    {isActive && (
                      <rect x="460" y={wy} width="120" height="32" rx="8" fill="none" stroke="#06b6d4" strokeWidth="1" opacity="0.3">
              ...
              <text x="690" y="166" textAnchor="middle" fill="#fff" fontSize="13" fontFamily="Outfit, sans-serif" fontWeight="600">QA</text>
              <text x="690" y="184" textAnchor="middle" fill="#33925d" fontSize="9" fontFamily="Source Code Pro, monospace">Tool</text>
              ...
              <circle r="3" fill="#25c2a0" filter="url(#glow-teal)" opacity="0">
                <animateMotion dur="1.5s" begin="1.05s" repeatCount="indefinite" path="M730,170 L770,170" />
                <animate attributeName="opacity" values="0;1;1;0" keyTimes="0;0.1;0.8;1" dur="1.5s" begin="1.05s" repeatCount="indefinite" />
              </circle>

              {/* ─── Writer Stage ─── */}
              <rect x="770" y="140" width="80" height="60" rx="10" fill="#0f1f1b" stroke="#25c2a0" strokeWidth="1.5" opacity="0.9" />
              <text x="810" y="166" textAnchor="middle" fill="#fff" fontSize="13" fontFamily="Outfit, sans-serif" fontWeight="600">Writer</text>
              <text x="810" y="184" textAnchor="middle" fill="#4fddbf" fontSize="9" fontFamily="Source Code Pro, monospace">DataFormat</text>
              ...
              {OUTPUT_FILES.map((file, i) => {
                ...
                return (
                  <g key={file}>
                    <line x1="850" y1={170} x2="870" y2={y + 16} stroke="#25c2a0" strokeWidth="1" opacity="0.25" />
                    <rect x="870" y={y} width="85" height="32" rx="6" fill="#0f1f1b" stroke="#1e3a32" strokeWidth="1" />
                    <text x="912" y={y + 20} textAnchor="middle" fill="#7aebd4" fontSize="10" fontFamily="Source Code Pro, monospace">{file}</text>
                    <circle r="2.5" fill="#25c2a0" opacity="0">
                      <animateMotion dur="2s" begin={`${i * 0.4 + 0.5}s`} repeatCount="indefinite"
                        path={`M850,170 L870,${y + 16}`} />
                      <animate attributeName="opacity" values="0;0.8;0.8;0" keyTimes="0;0.15;0.8;1" dur="2s" begin={`${i * 0.4 + 0.5}s`} repeatCount="indefinite" />
                    </circle>
                  </g>
                )
              })}
              ...
              <rect x="450" y="60" width="140" height="218" rx="12" fill="none" stroke="#06b6d4" strokeWidth="1" strokeDasharray="4 3" opacity="0.15" />
            </svg>
          </div>
        </div>
